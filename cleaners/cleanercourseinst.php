...
$query_getfaulty = "SELECT course_id, course_name, faculty_id, faculty_name FROM pel_edu_inst_courses ORDER BY course_id ASC";
...
//echo  $coursetwo= rtrim($courseone, "<br/>");

echo "<br/>";

 $updateSQL = sprintf("UPDATE pel_edu_inst_courses SET faculty_name=%s, course_name=%s WHERE faculty_id=%s and course_id=%s",
