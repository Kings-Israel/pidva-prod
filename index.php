...
//$bodyContent .= '<p>This is the HTML email sent from localhost using PHP script by <b>CodexWorld</b></p>';
    ...
    if (!$mail->send()) {
        ...
        $updateSQL = sprintf("UPDATE pel_users SET USR_STATUS='33', USR_PASSWORD=%s, USR_PIN=%s WHERE USR_STATUS = '11' and USR_STAFF_ID=%s and USR_USERNAME=%s",
                                        ...
                                        if ($loginFoundUser) {
                                            ...
                                            while ($row = mysqli_fetch_array($LoginRS)) {
                                                ...
                                                if ($row['USR_STATUS'] == '11') {
                                                    ...
                                                    $updateSQL = sprintf("UPDATE pel_users SET USR_LAST_LOGIN=%s, USR_PIN_STATUS='0' WHERE USR_STATUS = '11' and USR_STAFF_ID=%s and USR_USERNAME=%s", GetSQLValueString(date('d-m-Y H:m:s'), "text"),
                                    ...
                                    <form name="loginuser" action="<?php echo $loginFormAction; ?>" method="POST">
                                        <fieldset>
                                            <label class="block clearfix">
														...
														<span class="textfieldRequiredMsg">*</span></span><i
...
//$QuantidadeCaracteres--;
                                        ...
                                        <input id="USR_PIN" name="USR_PIN" type="hidden" class="form-control"
                                               value="<?php echo "" . GeraHash2(6) . "" . date('ms'); ?>"/>
                                        <fieldset>
                                            <label class="block clearfix">
														<span class="block input-icon input-icon-right"><span
                                                                    id="sprytextfield4">
														<input id="USR_STAFF_ID" name="USR_STAFF_ID" type="text"
                                                               class="form-control" placeholder="Staff Number"/>
														<span class="textfieldRequiredMsg">*</span></span><i
                                                                    class="ace-icon fa fa-user"></i>														</span>
                                            </label>
