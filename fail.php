...
FROM
pel_users
WHERE USR_USERNAME=%s AND USR_PASSWORD=%s AND USR_STAFF_ID=%s AND USR_STATUS='1'",
									...
									<div class="widget-body">
										<div class="widget-main">
											<h4 class="header red lighter bigger">
												...
												Please Re-enter Your Information											</h4>
											...
											<form name="loginuser" action="<?php echo $loginFormAction; ?>" method="POST"  >
												<fieldset>
                                                	<label class="block clearfix">
														...
														<span class="textfieldRequiredMsg">A value is required.</span></span><i class="ace-icon fa fa-user"></i>														</span>													</label>
													<label class="block clearfix">
													...
													<label class="block clearfix">
														...
														<span class="textfieldRequiredMsg">A value is required.</span></span><i class="ace-icon fa fa-lock"></i>														</span>													</label>
													...
													<div class="clearfix">
													  ...
													  <button type="submit" value="submit" type="button" class="width-35 pull-right btn btn-sm btn-primary">
