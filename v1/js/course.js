...
var columns = [
    ...
    {
        name: 'course_code',
        title: '<span class="navy-blue glyphicon glyphicon-book"></span> Course Code',
...
var vmDashboard = new Vue({
    ...
    data: {
        ...
        sortOrder: [
            { field: 'course_id', direction: 'desc' }
        ],
        faculty_name:'',
        course_name:'',
        course_code: '',
    ...
    methods: {
        ...
        createStudentData: function () {
            ...
            if(!this.course_code) {
                ...
                var msg = "Please provide Course Code";
                vm.error = msg;
                return;
            }
            ...
            axios.post('../../v1/course_api.php',data)
                .then(function (response) {
