...
$query_getallpayments = "SELECT * FROM pel_payments WHERE module_id='EDUCATION' ORDER BY payment_date ASC";
...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Education Payments - Peleza Admin</title>
					...
					<div class="breadcrumbs" id="breadcrumbs">
					  <script type="text/javascript">
						...
						<ul class="breadcrumb">
							...
							<li class="active">Edcheck Payments</li>
</ul><!-- /.breadcrumb -->
...
<div class="row">
                                    ...
                                    <div  class="col-xs-12">
									  ...
									  <h3 align="left" class="header smaller lighter blue">EDCHECK PAYMENTS</h3>
                                      </div>
                                        <!--    <div  class="col-xs-6">
...
?>
									  ...
									  Results for "Edcheck Payments"										</div>
								...
								<!--					  <th>Action</th>-->
                                                ...
                                                <!--      <td><?php echo $row_getallpayments['module_id']; ?></td>-->
                                                  ...
                                                  <td class="hidden-480"><?php 
														...
														{
														?>
                                                        <span class="label label-sm label-danger">UN SUCCESFULL</span>	
                                                         <?php
														}	
...
<!--<td>
                                                          <div class="hidden-sm hidden-xs action-buttons">
                                                                     ...
                                                                     <a href="#modal-viewclient-<?php echo $row_getallpayments['client_id']; ?>" role="button" class="green" data-toggle="modal">	    <button class="btn btn-xs btn-primary">  
																		<i class="ace-icon fa fa-search-plus bigger-130"></i>																	</button></a>  
                                                                 
                                                                 
            
                                                                 
<div id="modal-viewclient-<?php echo $row_getallpayments['client_id']; ?>" class="modal fade" tabindex="-1">
...
<table width="100%" border="0">
  <tr>
    ...
    <td><?php echo $row_getallpayments['client_first_name']; ?></td>
    <td><strong>Other Names:</strong></td>
    <td><?php echo $row_getallpayments['client_last_name']; ?></td>
  ...
  <tr>
   ...
   <tr>
    ...
    <td><?php echo $row_getallpayments['client_mobile_number']; ?></td> <td><strong>Client Email Address:</strong></td>
    <td><?php echo $row_getallpayments['client_email_address']; ?></td>
  ...
  <tr>
   ...
   <tr> <td><strong>Country</strong></td>
    <td><?php echo $row_getallpayments['client_country']; ?></td>
    <td><strong>Industry:</strong></td>
    <td><?php echo $row_getallpayments['client_industry']; ?></td>
  ...
  <tr>
    ...
    <td><button type="button" class="btn disabled btn-white btn-primary"><?php 		if($row_getallpayments['search_status']=='11')
														{
														?>
                                                       ACTIVE <?php
														}
														if($row_getallpayments['search_status']=='00')
														{
														?>
                                                DEACTIVATED
														...
														if($row_getallpayments['search_status']=='22')
														{
														?>
                                                   UNVERIFIED
    ...
    <td><?php echo $row_getallpayments['client_parent_company']; ?></td>
  </tr>
   <tr>
    <td colspan="4"><br/></td>
  </tr>
    ...
    <td><button type="button" class="btn disabled btn-white btn-primary"><?php echo $row_getallpayments['added_by']; ?></button></td>
    <td><strong>Added Date:</strong></td>
    <td><button type="button" class="btn disabled btn-white btn-primary"><?php echo $row_getallpayments['added_date']; ?></button></td>
  </tr>
  <tr>
    <td colspan="4"><br/></td>
  </tr>
    ...
    <td><button type="button" class="btn disabled btn-white btn-primary"><?php echo $row_getallpayments['verified_by']; ?></button></td>
    <td><strong>Verified Date:</strong></td>
    <td><button type="button" class="btn disabled btn-white btn-primary"><?php echo $row_getallpayments['verified_date']; ?></button></td>
  </tr><tr>
    <td colspan="4"><br/></td>
  </tr>
