					...
					<div class="breadcrumbs" id="breadcrumbs">
					  <script type="text/javascript">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="#">Peleza Reports</a>							</li>
                                
                                			<li>
								<a href="#">Company</a>							</li>
                              
							<li class="active">Company Full Report</li>
						</ul><!-- /.breadcrumb -->
...
<div class="row">
									<div class="col-xs-12">
									  ...
									  <h3 align="left" class="header smaller lighter blue">To View Compnay Data (Request Ref Number/Company Name/ Company Registration Number)</h3>
                                      </div>
                                         <!--   <div  class="col-xs-6">
...
<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Request Ref/Company Full Names:</label>

										<div class="col-sm-9"><span id="sprytextfield1">
																						     
										  <input type="text" id="search_ref" name="search_ref" class="col-xs-10 col-sm-5" /> <span class="textfieldRequiredMsg">*</span></span>
										</div>
                                     </div>
...
if($totalRows_getstudent>0)
{
	?>
	  ...
	  <h3 align="left" class=" smaller lighter blue"><strong>SEARCH PARAMETER: </strong>      <?php echo $search_ref;?></h3>
<div class="clearfix">
											<div class="pull-right tableTools-container"></div>
									  </div>
										<div class="table-header">
									  Results for "Request for company Details Searched"										</div>
...
?>                               
                            <a href="companyfullview.php?request_id=<?php echo $row_getstudent['request_id']; ?>" class="orange"><button class="btn btn-xs btn-info">  
															<i class="ace-icon fa fa-search bigger-120"></i>															</button>  </a>  
<?php
}
?>                                                                                                
                                                                 </td>
     ...
     <div class="alert alert-danger">
											...
											NO Data with Such parameter Existing.
											<br />
										</div>
