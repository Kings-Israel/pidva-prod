										...
										<thead>
												  ...
												  do { ?>
                                                   ...
                                                   <a href="#"><?php echo $row_getdetailssocial['website']; ?></a>																								</td>
                                                     ...
                                                     <td><a href="<?php echo $row_getdetailssocial['photo']; ?>" target="_blank"><img src="<?php echo $row_getdetailssocial['photo']; ?>" width="25px" height="25px" alt="Social Media Caption"></a>
	...
	?>
										...
										<thead>
                                               ...
                                               <td><?php echo $row_getdetailswatchlist['address']; ?></td>
                                                     ...
                                                     <td><a href="<?php echo $row_getdetailswatchlist['photo']; ?>" target="_blank"><img src="<?php echo $row_getdetailswatchlist['photo']; ?>" width="25px" height="25px" alt="Social Media Caption"></a>
