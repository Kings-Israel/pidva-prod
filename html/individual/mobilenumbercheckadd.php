...
$colname_getmobile_number_id = "-1";
if (isset($_GET['mobile_number_id_move'])) {
    $colname_getmobile_number_id = $_GET['mobile_number_id_move'];
}
...
-->
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <h3 align="left" class="header smaller lighter blue">Add Individual Mobile Number
                                        Details</h3>
                                </div>
                                <!--   <div  class="col-xs-6">
                         ...
                         <button class="btn btn-white btn-info btn-bold">
                                ...
                                <div>
                                    ...
                                    <a href="mobilenumbercheck.php?request_id=<?php echo $row_getstudent['request_id']; ?>&moduleid=<?php echo $colname_getmoduleid; ?>"
                                    ...
                                    <?php
                                    if (isset($_GET['request_id']) && isset($_GET['moduleid']) && !isset($_GET['mobile_number_id_move'])) {
                                    ...
                                    <?php
                                    if (isset($_GET['mobile_number_id_move']) && isset($_GET['request_id'])) {

                                    $mobile_number_id = $colname_getmobile_number_id;
                                    $query_getdetails = "SELECT * FROM pel_data_mobile_number WHERE mobile_number_id = '" . $mobile_number_id . "'";
                                    ...
                                    <div class="col-lg-12" align="center"><h3 align="left"
                                                                              class=" smaller lighter blue"><strong>MOBILE
                                                NUMBER CHECK DETAILS: </strong>
                                        </h3>
                                    ...
                                    <div class="modal-body padding">
                                        <form enctype="multipart/form-data" method="POST"
                                            ...
                                            <input type="hidden" id="moduleid" name="moduleid"
                                                   value="<?php echo $colname_getmoduleid; ?>"/>
                                            <input type="hidden" id="mobile_number_id" name="mobile_number_id"
                                                   value="<?php echo $row_getdetails['mobile_number_id']; ?>"/>
                                            ...
                                            <div class="col-sm-8">
                                                <!-- <span id="sprytextfield1">
                                                    <input type="text" id="line_provider" name="line_provider"
                                                        value="<?php echo $row_getdetails['line_provider']; ?>"
                                                        required/>
                                                    <span class="textfieldRequiredMsg">*</span>
                                                </span> -->
                                                <select class="chosen-select form-control" type="text" id="line_provider" 
                                            ...
                                            <div class="col-sm-8"><span id="sprytextfield4">
                                                                <input type="text"
                                                                       value="<?php echo $row_getdetails['mobile_number']; ?>"
                                                                       id="mobile_number"
                                                                       name="mobile_number" required/>
                                                              <span class="textfieldRequiredMsg">*</span></span></div>
