...
$a = $_POST['search_id']."-".$date_insert; 
$rawname = $_FILES['photo']['name'];
 	  "Upload: ".$a."_". $_FILES["photo"]["name"];
	  $file="socialmediaphotos/".$a."_". $_FILES["photo"]["name"];

 $filenameuploaded = $a."_".$_FILES["photo"]["name"];

    require_once "../../uploads.php";
    $prefix = "photo";
    $filenameuploaded = uploadFile($prefix,"individual-socialmediaphotos",$a."_".$_FILES[$prefix]["name"]);
...
$filenameuploaded = $_POST['photo2']; 
 ...
 $editorCopy_post = $_POST['editorCopy_post']; 
 $data_notesn = "data_notes".$editorCopy_post;

 $data_notes = $_POST[$data_notesn]; 

  $updateSQL = sprintf("UPDATE pel_data_social_media SET website=%s, status=%s, social_media_handle=%s, added_by=%s, search_id=%s, data_source=%s, data_notes=%s, adverse_status=%s, date_added=now(), photo=%s WHERE social_media_id=%s",
                       GetSQLValueString(strtoupper($_POST['website']), "text"),
					   GetSQLValueString("22", "text"),
                       GetSQLValueString(strtoupper($_POST['social_media_handle']), "text"),
                       GetSQLValueString($_POST['added_by'], "text"),
                       GetSQLValueString($_POST['search_id'], "text"),
					   GetSQLValueString($_POST['data_source'], "text"),
                       GetSQLValueString($data_notes, "text"),
					   GetSQLValueString($_POST['adverse_status'], "text"),
					   GetSQLValueString($filenameuploaded, "text"),
					   GetSQLValueString($_POST['social_media_id'], "text"));
...
$errorcode = '<div class="alert alert-danger">
											...
											<strong>
											 ...
											 Details were not updated succesfully.
											<br />
										</div>';
...
else
{
  ...
  $updateGoTo = "socialmediacheck.php?request_id=$colname_getrequestid&moduleid=$colname_getmoduleid";
 /* if (isset($_SERVER['QUERY_STRING'])) {
...
$insertSQL = sprintf("INSERT INTO pel_data_social_media (website, status, social_media_handle, added_by, search_id, data_source, data_notes, adverse_status, date_added, photo) VALUES (%s, %s, %s,%s, %s, %s, %s, %s, now(), %s)",
                       GetSQLValueString(strtoupper($_POST['website']), "text"),
					   GetSQLValueString("22", "text"),
                       GetSQLValueString(strtoupper($_POST['social_media_handle']), "text"),
                       GetSQLValueString($_POST['added_by'], "text"),
...
$deleteSQLreject = sprintf("UPDATE pel_data_social_media SET status=%s, review_status=%s, verified_by=%s, verified_date=now(), review_notes=%s WHERE search_id=%s and social_media_id=%s",
					   ...
					   GetSQLValueString($_POST['review_notes'], "text"),
						...
						GetSQLValueString($_POST['social_media_id'], "int"));
					   mysqli_select_db($connect,$database_connect);
...
if ((isset($_GET['social_media_id'])) && ($_GET['social_media_id'] != "")) {
if($_GET['status']=='00')
{
  $deleteSQL = sprintf("UPDATE pel_data_social_media SET status=%s, added_by=%s, date_added=now() WHERE social_media_id=%s",
                       GetSQLValueString($_GET['status'], "text"),
					   GetSQLValueString($_GET['fullnames'], "text"),
					    GetSQLValueString($_GET['social_media_id'], "int"));
					   mysqli_select_db($connect,$database_connect);
...
if($_GET['status']=='11')
{
   ...
   $deleteSQL2 = sprintf("UPDATE pel_data_social_media SET status=%s, review_status=%s, verified_by=%s, verified_date=now() WHERE search_id=%s and social_media_id=%s",
                       GetSQLValueString($_GET['status'], "text"),
...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Individual Social Media Details Data Management - Peleza Admin</title>
					...
					<div class="breadcrumbs" id="breadcrumbs">
					  <script type="text/javascript">
						...
						<ul class="breadcrumb">
							...
							<li class="active">Individual Social Media Details</li>
						</ul><!-- /.breadcrumb -->
...
<div class="row">
									<div class="col-xs-12">
									  ...
									  <h3 align="left" class="header smaller lighter blue">Add Individual Social Media Details</h3>
                                      </div>
                                         <!--   <div  class="col-xs-6">
...
$query_getdetails = "SELECT * FROM pel_data_social_media WHERE search_id = '".$search_ref."'";
...
if($totalRows_getdetails>0)
{
	?> 
										...
										<div class="col-lg-12" align="center"> <h3 align="left" class=" smaller lighter blue"><strong>SOCIAL MEDIA CHECK DETAILS: </strong> 
</h3> 
<?php
$n = 1;
do
										...
										<thead>
													<tr>									
													  <th>SOURCE:</th>                                                    
                                                   	...
                                                   	<tr>
<td>
                                                   <a href="#"><?php echo $row_getdetails['website']; ?> </a>																								</td>
                                                   <td><?php echo $row_getdetails['adverse_status']; ?></td> 
                                                   <td><?php echo $row_getdetails['social_media_handle']; ?></td>
	...
	<i class="ace-icon fa fa-hand-o-right icon-animated-hand-pointer blue"></i><a href="socialmediacheckadd.php?request_id=<?php echo $row_getstudent['request_id']; ?>&social_media_id_move=<?php echo $row_getdetails['social_media_id']; ?>&moduleid=<?php echo $colname_getmoduleid; ?>" role="button" class="green" data-toggle="modal">	
                                 <button class="btn btn-xs btn-info">  
															<i class="ace-icon fa fa-pencil bigger-120"></i>															</button></a>

   <div id="modal-editdetails-<?php echo $row_getdetails['social_media_id']; ?>" class="modal fade" tabindex="-1"><div class="modal-dialog"><div class="modal-content"><div class="modal-header no-padding">
 ...
 <input type="hidden" id="moduleid" name="moduleid" value="<?php echo $colname_getmoduleid; ?>"/>
										<input type="hidden" id="social_media_id" name="social_media_id" value="<?php echo $row_getdetails['social_media_id']; ?>"/>
     ...
     <input type="hidden" id="added_by" name="added_by" value="<?php echo $_SESSION['MM_full_names']."(".$_SESSION['MM_USR_EMAIL'].")"; ?>"/>
           <input type="hidden" id="date_added" name="date_added" value="<?php echo date('Y-m-d H:m:s');?>"/>
           						...
           						<div class="space-10"></div>
																...
																<label class="col-sm-4">Website Name</label>

																<div class="col-sm-8"><span id="sprytextfield1">
																  <input type="text" id="website" name="website" value="<?php echo $row_getdetails['website']; ?>"  required/>
											    <span class="textfieldRequiredMsg">*</span></span></div>
			<br/>
            <div class="space-10"></div>
            	<label class="col-sm-4">Social Media Handle</label>

															  <div class="col-sm-8"><span id="sprytextfield4">
															    <input  type="text" value="<?php echo $row_getdetails['social_media_handle']; ?>" id="social_media_handle" name="social_media_handle"  required/>
														      <span class="textfieldRequiredMsg">*</span></span></div>
				...
				<div class="space-10"></div>
					...
					<br/>
                    	<div class="space-10"></div>
																...
																<label class="col-sm-4">Adverse Status</label>

																<div class="col-sm-8">
															  <select class="chosen-select form-control"  name="adverse_status" id="adverse_status"  data-placeholder="Choose Adverse Status..." required>
														    <!--  <select name="client_industry" id="client_industry">-->
                                                           <option  value="<?php echo $row_getdetails['adverse_status']; ?>"><?php echo $row_getdetails['adverse_status']; ?></option>
														        <option value="">Adverse Status</option>
						...
						<br/>
								<div class="space-10"></div>
														...
														<label class="col-sm-4">Social Media Photo</label>

														<div class="col-sm-8">
															 Current Photo <br/>
                                                             	<img width="200px" height="200px" src="<?php echo $row_getdetails['photo']; ?>" alt="Social Media Photos">
		...
		<!--	<textarea name="data_notes<?php echo $n;?>" id="editorCopy2" required="required" style="display:none;"><?php echo $row_getdetails['data_notes']; ?></textarea>-->
...
<button class="btn" type="reset">
                                ...
                                <?php
                                	if($row_getdetails['status']=='11' || $row_getdetails['status']=='22')
														{
														?>
                                                        <a href="socialmediacheck.php?fullnames=<?php echo $_SESSION['MM_full_names']."(".$_SESSION['MM_USR_EMAIL'].")"; ?>&status=00&social_media_id=<?php echo $row_getdetails['social_media_id']; ?>&request_id=<?php echo $colname_getrequestid; ?>&moduleid=<?php echo $colname_getmoduleid; ?>"> <button class="btn btn-xs btn-danger">
                                	...
                                	if($row_getdetails['status']=='00')
														...
														?>
                                                    <a href="socialmediacheck.php?fullnames=<?php echo $_SESSION['MM_full_names']."(".$_SESSION['MM_USR_EMAIL'].")"; ?>&status=22&social_media_id=<?php echo $row_getdetails['social_media_id']; ?>&request_id=<?php echo $colname_getrequestid; ?>&moduleid=<?php echo $colname_getmoduleid; ?>"> <button class="btn btn-xs btn-success">
...
<?php
                                               ...
                                               <thead> 
                                                 	 	<tr>	  <td>
                                                <strong>SOCIAL MEDIA PHOTO:</strong>
                                                        </td> 				
                                                 <td>
                                                <strong>NOTES:</strong>
                                                        </td> 		
                                                    ...
                                                    <tr>
                                                    <td width="50%"><img width="200px" src="<?php echo $row_getdetails['photo']; ?>">
                                   </td>
                                                     <td>
...
?>
        ...
        <i class="ace-icon fa fa-hand-o-right icon-animated-hand-pointer blue"></i><a href="socialmediacheck.php?fullnames=<?php echo $_SESSION['MM_full_names']."(".$_SESSION['MM_USR_EMAIL'].")"; ?>&status=11&search_id_approve=<?php echo $search_ref; ?>&request_id=<?php echo $colname_getrequestid; ?>&moduleid=<?php echo $colname_getmoduleid; ?>&social_media_id=<?php echo $row_getdetails['social_media_id']; ?>"> <button class="btn btn-xs btn-success">
															<i class="ace-icon fa fa-check bigger-120">Approve</i>															</button></a>
                                                            
                                                              <i class="ace-icon fa fa-hand-o-right icon-animated-hand-pointer blue"></i><a href="#modal-addreject-<?php echo $row_getdetails['social_media_id']; ?>" role="button" class="blue" data-toggle="modal">	
                                 <button class="btn btn-xs btn-danger"> Reject With Reason															</button></a> 
							  <div id="modal-addreject-<?php echo $row_getdetails['social_media_id']; ?>" class="modal fade" tabindex="-1"><div class="modal-dialog"><div class="modal-content"><div class="modal-header no-padding">
												<div class="table-header">
													<button type="button" class="close" data-dismiss="modal" aria-hidden="true">
														<span class="white">&times;</span>													</button>
...
<br/><br/>
<i class="ace-icon fa fa-hand-o-right icon-animated-hand-pointer blue"></i><a href="#"  role="button" class="orange"data-toggle="modal">	
    ...
    -->
    <a href="socialmediacheckadd.php?request_id=<?php echo $row_getstudent['request_id']; ?>&moduleid=<?php echo $colname_getmoduleid; ?>" role="button" class="green">	
                                 <button class="btn btn-xs btn-primary">
...
<div id="modal-adddetails" class="modal fade" tabindex="-1"><div class="modal-dialog"><div class="modal-content"><div class="modal-header no-padding">
           ...
           <input type="hidden" id="date_added" name="date_added" value="<?php echo date('Y-m-d H:m:s');?>"/>
            ...
            <div class="space-10"></div>
            	<label class="col-sm-4">Social Media Handle</label>
															  ...
															  <div class="col-sm-8"><span id="sprytextfield4">
															    <input class="form-control" type="text" id="social_media_handle" name="social_media_handle"  required/>
														      <span class="textfieldRequiredMsg">*</span></span></div>
 ...
 <div class="col-sm-8">
		...
		<textarea name="data_notes" id="editorCopy" required="required" style="display:none;"></textarea>
	</div>
                                                 <br/>   
                                   	<div class="space-10"></div>
