																			...
																			<form method="POST" enctype="multipart/form-data" action="<?php echo $editFormAction; ?>" class="form-horizontal" id="updateform">
																				...
																				<div class="col-sm-12">
																					<div id="editparent">
																						...
																						<textarea name="data_notes" required="required" cols="140" rows="10" style="border-radius: 10px; margin-top: 10px"><?php echo isset($row_getdetails['data_notes']) ? $row_getdetails['data_notes'] : '' ?></textarea>
																					</div>
