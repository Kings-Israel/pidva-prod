...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "editdetails")) {
  ...
  $updateSQL = sprintf("UPDATE pel_individual_credit_data SET subscriber=%s, loan_status=%s, status=%s, total_amount=%s, added_by=%s, loan_type=%s, balance=%s, past_due=%s, closed_date=%s, data_source=%s WHERE credit_individual_id=%s",
					   ...
					   GetSQLValueString($_POST['credit_individual_id'], "int"));
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "editcomments")) {
  ...
  $updateSQL = sprintf("UPDATE pel_credit_data_comments SET status=%s, date_added=now(), added_by=%s, data_notes=%s WHERE credit_comm_id=%s",
                       GetSQLValueString($_POST['status'], "text"),
                       GetSQLValueString($_POST['added_by'], "text"),
...
$insertSQL = sprintf("INSERT INTO pel_individual_credit_data (subscriber, loan_status, status, total_amount, loan_type, added_by, balance, past_due, data_source, closed_date, date_added, search_id) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, now(), %s)",
                       GetSQLValueString(strtoupper($_POST['subscriber']), "text"),
                       GetSQLValueString(strtoupper($_POST['loan_status']), "text"),
                       GetSQLValueString($_POST['status'], "text"),
                       GetSQLValueString($_POST['total_amount'], "text"),
...
$insertSQL = sprintf("INSERT INTO pel_credit_data_comments (status, added_by, date_added, data_notes, search_id, comment_type) VALUES (%s, %s, now(), %s, %s, 'DATA COMMENT')",
                       GetSQLValueString($_POST['status'], "text"),
                       GetSQLValueString($_POST['added_by'], "text"),
                       GetSQLValueString($_POST['data_notes'], "text"),
					   GetSQLValueString($_POST['search_id'], "text"));
...
$insertSQL = sprintf("INSERT INTO pel_credit_data_comments (status, verified_by, verified_date, review_notes, search_id,  review_status,comment_type) VALUES (%s, %s, now(), %s, %s, 'REJECTED', 'DATA REVIEW')",
                       GetSQLValueString($_POST['status'], "text"),
 ...
 mysqli_select_db($connect,$database_connect); 
  ...
  $deleteSQL = sprintf("UPDATE pel_credit_data_comments SET status=%s, verified_by=%s, date_added=now() WHERE search_id=%s",
  ...
  $Result1 = mysqli_query_ported($deleteSQL, $connect) or die(mysqli_error($connect));
   ...
   $deleteSQL2 = sprintf("UPDATE pel_individual_credit_data SET status=%s, verified_by=%s, verified_date=now() WHERE search_id=%s",
                       GetSQLValueString('00', "text"),
					   GetSQLValueString($_POST['verified_by'], "text"),
					    GetSQLValueString($_POST['search_id'], "int"));
					   mysqli_select_db($connect,$database_connect);
...
if ((isset($_GET['credit_individual_id'])) && ($_GET['credit_individual_id'] != "")) {
if($_GET['status']=='00')
{
  $deleteSQL = sprintf("UPDATE pel_individual_credit_data SET status=%s, added_by=%s WHERE credit_individual_id=%s",
                       GetSQLValueString($_GET['status'], "text"),
					   GetSQLValueString($_GET['fullnames'], "text"),
					    GetSQLValueString($_GET['credit_individual_id'], "int"));
					   mysqli_select_db($connect,$database_connect);
  $Result1 = mysqli_query_ported($deleteSQL, $connect) or die(mysqli_error($connect));
...
if($_GET['status']=='11')
{
 $deleteSQL = sprintf("UPDATE pel_credit_data_comments SET status=%s, verified_by=%s, verified_date=now() WHERE search_id=%s",
                       GetSQLValueString($_GET['status'], "text"),
					   GetSQLValueString($_GET['fullnames'], "text"),
...
if($_GET['status']=='00')
{
  $deleteSQL = sprintf("UPDATE pel_credit_data_comments SET status=%s, added_by=%s, date_added=now() WHERE credit_comm_id=%s",
                       GetSQLValueString($_GET['status'], "text"),
					   GetSQLValueString($_GET['fullnames'], "text"),
...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Individual Credit Details Data Management - Peleza Admin</title>
					...
					<div class="breadcrumbs" id="breadcrumbs">
					  <script type="text/javascript">
						...
						<ul class="breadcrumb">
							...
							<li class="active">Individual Credit Details</li>
						</ul><!-- /.breadcrumb -->
...
<div class="row">
									<div class="col-xs-12">
									  ...
									  <h3 align="left" class="header smaller lighter blue">Add Individual Credit Details</h3>
                                      </div>
                                         <!--   <div  class="col-xs-6">
...
$query_getdetails = "SELECT * FROM pel_individual_credit_data WHERE search_id = '".$search_ref."' ORDER BY loan_status ASC";
...
$totalRows_getdetailscredit_comments= 0;
$query_getdetails2 = "SELECT * FROM pel_individual_credit_data WHERE search_id = '".$search_ref."' AND loan_status = 'OPEN' ORDER BY loan_status ASC";
...
{
	?> 
<div class="col-lg-12" align="center"> <h3 align="left" class=" smaller lighter blue"><strong>INDIVIDUAL CREDIT CHECK DETAILS: </strong> 
</h3>
      	<table id="simple-table" class="table  table-striped  table-bordered table-hover">
                                           <tr><td colspan="9"><h4 align="left" class=" smaller lighter blue"><strong>CLOSED LOANS: </strong> 
</h4></td></tr>
										<thead> 
													<tr>									
													  <th>SUBSCRIBER:</th>
	   ...
	   if($row_getdetails['loan_status']=='CLOSED')
{
	   ?>    
                                                   	<tr>			     
                                                       	...
                                                       	<td>
                                                   <a href="#"><?php echo $row_getdetails['subscriber']; ?> </a>																								</td>
                                                       ...
                                                       <td><?php echo number_format($row_getdetails['total_amount']); ?></td>
                                                          <td><?php echo number_format($row_getdetails['balance']); ?></td>  
                                                           <td><?php echo $row_getdetails['past_due']; ?></td> 
                                                             <td><?php echo $row_getdetails['closed_date']; ?></td> 
                                                            <td><?php 
	...
	<i class="ace-icon fa fa-hand-o-right icon-animated-hand-pointer blue"></i><a href="#modal-editdetails-<?php echo $row_getdetails['credit_individual_id']; ?>" role="button" class="green" data-toggle="modal">	
                                 <button class="btn btn-xs btn-info">  
															<i class="ace-icon fa fa-pencil bigger-120"></i>															</button></a>

   <div id="modal-editdetails-<?php echo $row_getdetails['credit_individual_id']; ?>" class="modal fade" tabindex="-1"><div class="modal-dialog"><div class="modal-content"><div class="modal-header no-padding">
									  ...
									  Edit Details</div>
                                            ...
                                            <div class="modal-body padding">	  <form method="POST" action="<?php echo $editFormAction; ?>" class="form-horizontal" name="editdetails" >
 ...
 <input type="hidden" id="moduleid" name="moduleid" value="<?php echo $colname_getmoduleid; ?>"/>
										<input type="hidden" id="credit_individual_id" name="credit_individual_id" value="<?php echo $row_getdetails['credit_individual_id']; ?>"/>
...
<button class="btn" type="reset">
                                ...
                                <?php
                                	if($row_getdetails['status']=='11' || $row_getdetails['status']=='22')
														{
														?>
                                                        <a href="creditcheck.php?fullnames=<?php echo $_SESSION['MM_full_names']."(".$_SESSION['MM_USR_EMAIL'].")"; ?>&status=00&credit_individual_id=<?php echo $row_getdetails['credit_individual_id']; ?>&request_id=<?php echo $colname_getrequestid; ?>&moduleid=<?php echo $colname_getmoduleid; ?>"> <button class="btn btn-xs btn-danger">
                                	...
                                	if($row_getdetails['status']=='00')
														...
														?>
                                                    <a href="creditcheck.php?fullnames=<?php echo $_SESSION['MM_full_names']."(".$_SESSION['MM_USR_EMAIL'].")"; ?>&status=22&credit_individual_id=<?php echo $row_getdetails['credit_individual_id']; ?>&request_id=<?php echo $colname_getrequestid; ?>&moduleid=<?php echo $colname_getmoduleid; ?>"> <button class="btn btn-xs btn-success">
...
<?php
                                            ...
                                            <tr><td colspan="9"><h4 align="left" class=" smaller lighter blue"><strong>OPEN LOANS: </strong> 
</h4></td></tr>
                                                               <?php
												  $total_open = 0;
	   ...
	   if($row_getdetails2['loan_status']=='OPEN')
{
	   ?>    
                                                   	<tr>			     
                                                       	...
                                                       	<td>
                                                   <a href="#"><?php echo $row_getdetails2['subscriber']; ?> </a>																								</td>
	...
	<i class="ace-icon fa fa-hand-o-right icon-animated-hand-pointer blue"></i><a href="#modal-editdetails-<?php echo $row_getdetails2['credit_individual_id']; ?>" role="button" class="green" data-toggle="modal">	
                                 <button class="btn btn-xs btn-info">  
															<i class="ace-icon fa fa-pencil bigger-120"></i>															</button></a>

   <div id="modal-editdetails-<?php echo $row_getdetails2['credit_individual_id']; ?>" class="modal fade" tabindex="-1"><div class="modal-dialog"><div class="modal-content"><div class="modal-header no-padding">
												<div class="table-header">
													<button type="button" class="close" data-dismiss="modal" aria-hidden="true">
														<span class="white">&times;</span>													</button>
									  Edit Details</div>
 ...
 <input type="hidden" id="moduleid" name="moduleid" value="<?php echo $colname_getmoduleid; ?>"/>
										<input type="hidden" id="credit_individual_id" name="credit_individual_id" value="<?php echo $row_getdetails2['credit_individual_id']; ?>"/>
...
<button class="btn" type="reset">
                                ...
                                <?php
                                	if($row_getdetails2['status']=='11' || $row_getdetails2['status']=='22')
														{
														?>
                                                        <a href="creditcheck.php?fullnames=<?php echo $_SESSION['MM_full_names']."(".$_SESSION['MM_USR_EMAIL'].")"; ?>&status=00&credit_individual_id=<?php echo $row_getdetails2['credit_individual_id']; ?>&request_id=<?php echo $colname_getrequestid; ?>&moduleid=<?php echo $colname_getmoduleid; ?>"> <button class="btn btn-xs btn-danger">
															<i class="ace-icon fa fa-trash-o bigger-120"></i>															</button></a>  <?php
						}                                
                                	if($row_getdetails['status']=='00')
														{
														...
														?>
                                                    <a href="creditcheck.php?fullnames=<?php echo $_SESSION['MM_full_names']."(".$_SESSION['MM_USR_EMAIL'].")"; ?>&status=22&credit_individual_id=<?php echo $row_getdetails2['credit_individual_id']; ?>&request_id=<?php echo $colname_getrequestid; ?>&moduleid=<?php echo $colname_getmoduleid; ?>"> <button class="btn btn-xs btn-success">
															<i class="ace-icon fa fa-check bigger-120"></i>															</button></a>
<?php
														}
														?>
											...
											<table id="simple-table" class="table  table-striped  table-bordered table-hover">
                                                ...
                                                <strong>NOTES:</strong>
                                                    ...
                                                    <?php 
														...
														?> 
                                                        </td><td><i class="ace-icon fa fa-hand-o-right icon-animated-hand-pointer blue"></i><a href="#modal-editcomments-<?php echo $row_getdetailscredit_comments['credit_comm_id']; ?>" role="button" class="green" data-toggle="modal">	
                                 <button class="btn btn-xs btn-info">  
															<i class="ace-icon fa fa-pencil bigger-120"></i>															</button></a>
															
										  <div id="modal-editcomments-<?php echo $row_getdetailscredit_comments['credit_comm_id']; ?>" class="modal fade" tabindex="-1"><div class="modal-dialog"><div class="modal-content"><div class="modal-header no-padding">
												<div class="table-header">
													<button type="button" class="close" data-dismiss="modal" aria-hidden="true">
														<span class="white">&times;</span>													</button>
									  Edit Details</div>
                                            ...
                                            <div class="modal-body padding">	  <form method="POST" action="<?php echo $editFormAction; ?>" class="form-horizontal" name="editcomments" >
 <input type="hidden" id="request_id" name="request_id" value="<?php echo $colname_getrequestid; ?>"/>
     ...
     <input type="hidden" id="added_by" name="added_by" value="<?php echo $_SESSION['MM_full_names']."(".$_SESSION['MM_USR_EMAIL'].")"; ?>"/>
		...
		<div id="editControls">
			...
			<div class="btn-group">
				...
				<a class="btn btn-xs btn-default" data-role="h3" href="#" title="Heading 3"><i class="fa fa-header"></i><sup>3</sup></a><a class="btn btn-xs btn-default" data-role="h4" href="#" title="Heading 4"><i class="fa fa-header"></i><sup>4</sup></a>
				<a class="btn btn-xs btn-default" data-role="p" href="#" title="Paragraph"><i class="fa fa-paragraph"></i></a>
			</div>
		</div>
		<div id="editor" contenteditable><?php echo $row_getdetailscredit_comments['data_notes']; ?></div>
		<textarea name="data_notes" id="editorCopy" required style="display:none;"><?php echo $row_getdetailscredit_comments['data_notes']; ?></textarea>
	</div>
					...
					if($row_getdetailscredit_comments['status']!='11' && $row_getdetailscredit_comments['status']!='22' && $row_getdetailscredit_comments['status']!='00')
{
             ...
             <i class="ace-icon fa fa-hand-o-right icon-animated-hand-pointer blue"></i><a href="#modal-addcomments" role="button" class="blue" data-toggle="modal">	
                                 <button class="btn btn-xs btn-info"> Add Comments															</button></a> 
										  ...
										  <div id="modal-addcomments" class="modal fade" tabindex="-1"><div class="modal-dialog"><div class="modal-content"><div class="modal-header no-padding">
												<div class="table-header">
													<button type="button" class="close" data-dismiss="modal" aria-hidden="true">
														<span class="white">&times;</span>													</button>
									  Edit Details</div>
                                            ...
                                            <div class="modal-body padding">	  <form method="POST" action="<?php echo $editFormAction; ?>" class="form-horizontal" name="addcomments" >
                                      <input type="hidden" id="request_id" name="request_id" value="<?php echo $colname_getrequestid; ?>"/>
...
<button class="btn" type="reset">
 ...
 <div id="modal-adddetails" class="modal fade" tabindex="-1"><div class="modal-dialog"><div class="modal-content"><div class="modal-header no-padding">
									  ...
									  Add Details</div>
                                            ...
                                            <div class="modal-body padding">	  <form method="POST" action="<?php echo $editFormAction; ?>" class="form-horizontal" name="newdetails" >
                                          <input type="hidden" id="request_id" name="request_id" value="<?php echo $colname_getrequestid; ?>"/>
                                                           <input type="hidden" id="moduleid" name="moduleid" value="<?php echo $colname_getmoduleid; ?>"/>
											<input type="hidden" id="search_id" name="search_id" value="<?php echo $search_ref; ?>"/>
