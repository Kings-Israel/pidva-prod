...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "editdetails")) {
  ...
  $updateSQL = sprintf("UPDATE pel_individual_gap_data SET gap_name=%s, status=%s, from_date=%s, added_by=%s, search_id=%s, data_source=%s, data_notes=%s, to_date=%s, date_added=now() WHERE gap_id=%s",
                       GetSQLValueString(strtoupper($_POST['gap_name']), "text"),
					   GetSQLValueString("22", "text"),
                       GetSQLValueString(strtoupper($_POST['from_date']), "text"),
					   ...
					   GetSQLValueString(strtoupper($_POST['to_date']), "text"),
					   GetSQLValueString($_POST['gap_id'], "text"));
...
else
{
  ...
  $updateGoTo = "gapanalysischeck.php?request_id=$colname_getrequestid&moduleid=$colname_getmoduleid";
 /* if (isset($_SERVER['QUERY_STRING'])) {
...
$insertSQL = sprintf("INSERT INTO pel_individual_gap_data (gap_name, status, from_date, added_by, search_id, data_source, data_notes, to_date, date_added) VALUES (%s, %s, %s,%s, %s, %s, %s, %s, now())",
                       GetSQLValueString(strtoupper($_POST['gap_name']), "text"),
					   GetSQLValueString("22", "text"),
                       GetSQLValueString(strtoupper($_POST['from_date']), "text"),
                       GetSQLValueString($_POST['added_by'], "text"),
...
$deleteSQLreject = sprintf("UPDATE pel_individual_gap_data SET status=%s, review_status=%s, verified_by=%s, verified_date=now(), review_notes=%s WHERE search_id=%s and gap_id=%s",
					   ...
					   GetSQLValueString($_POST['review_notes'], "text"),
					    GetSQLValueString($_POST['search_id'], "text"),
						GetSQLValueString($_POST['gap_id'], "int"));
					   mysqli_select_db($connect,$database_connect);
...
if ((isset($_GET['gap_id'])) && ($_GET['gap_id'] != "")) {
if($_GET['status']=='00')
{
  $deleteSQL = sprintf("UPDATE pel_individual_gap_data SET status=%s, added_by=%s, date_added=now() WHERE gap_id=%s",
                       GetSQLValueString($_GET['status'], "text"),
					   GetSQLValueString($_GET['fullnames'], "text"),
					    GetSQLValueString($_GET['gap_id'], "int"));
					   mysqli_select_db($connect,$database_connect);
...
if($_GET['status']=='11')
{
   ...
   $deleteSQL2 = sprintf("UPDATE pel_individual_gap_data SET status=%s, review_status=%s, verified_by=%s, verified_date=now() WHERE search_id=%s and gap_id=%s",
                       GetSQLValueString($_GET['status'], "text"),
...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Individual Gap Analysis Data Management - Peleza Admin</title>
					...
					<div class="breadcrumbs" id="breadcrumbs">
					  <script type="text/javascript">
						...
						<ul class="breadcrumb">
							...
							<li class="active">Individual Gap Analysis Details</li>
						</ul><!-- /.breadcrumb -->
...
<div class="row">
									<div class="col-xs-12">
									  ...
									  <h3 align="left" class="header smaller lighter blue">Add Individual Gap Analysis Details</h3>
                                      </div>
                                         <!--   <div  class="col-xs-6">
...
$query_getdetails = "SELECT * FROM pel_individual_gap_data WHERE search_id = '".$search_ref."'";
...
if($totalRows_getdetails>0)
{
	?> 
										...
										<div class="col-lg-12" align="center"> <h3 align="left" class=" smaller lighter blue"><strong>GAP ANALYSIS CHECK DETAILS: </strong> 
</h3> 
<?php
do
{
										...
										<thead>
													<tr>									
													  <th>GAP</th>                                                    
                                                   	...
                                                   	<tr>
<td>
                                                   <a href="#"><?php echo $row_getdetails['gap_name']; ?> </a>																								</td>
                                                    <td><?php echo $row_getdetails['from_date']; ?></td>
                                                    <td><?php echo $row_getdetails['to_date']; ?></td> 
   ...
   <a href="gapanalysischeckadd.php?request_id=<?php echo $row_getstudent['request_id']; ?>&gap_id_move=<?php echo $row_getdetails['gap_id']; ?>&moduleid=<?php echo $colname_getmoduleid; ?>" role="button" class="green" data-toggle="modal">	
                                 <button class="btn btn-xs btn-info">  
															<i class="ace-icon fa fa-pencil bigger-120"></i>															</button></a>

   <div id="modal-editdetails-<?php echo $row_getdetails['gap_id']; ?>" class="modal fade" tabindex="-1"><div class="modal-dialog"><div class="modal-content"><div class="modal-header no-padding">
 ...
 <input type="hidden" id="moduleid" name="moduleid" value="<?php echo $colname_getmoduleid; ?>"/>
										<input type="hidden" id="gap_id" name="gap_id" value="<?php echo $row_getdetails['gap_id']; ?>"/>
     ...
     <input type="hidden" id="added_by" name="added_by" value="<?php echo $_SESSION['MM_full_names']."(".$_SESSION['MM_USR_EMAIL'].")"; ?>"/>
           <input type="hidden" id="date_added" name="date_added" value="<?php echo date('Y-m-d H:m:s');?>"/>
           						...
           						<div class="space-10"></div>
																...
																<label class="col-sm-4">Gap Name</label>

																<div class="col-sm-8"><span id="sprytextfield1">
																  <input type="text" id="gap_name" name="gap_name" value="<?php echo $row_getdetails['gap_name']; ?>"  required/>
            ...
            <div class="space-10"></div>
            	<label class="col-sm-4">From Date</label>
															  ...
															  <div class="col-sm-8"><span id="sprytextfield4">
															    <input  type="text" value="<?php echo $row_getdetails['from_date']; ?>" id="from_date" name="from_date"  required/>
														      <span class="textfieldRequiredMsg">*</span></span></div>
            ...
            <div class="space-10"></div>
            	<label class="col-sm-4">To Date</label>
															  ...
															  <div class="col-sm-8"><span id="sprytextfield4">
															    <input  type="text" value="<?php echo $row_getdetails['to_date']; ?>" id="to_date" name="to_date"  required/>
														      <span class="textfieldRequiredMsg">*</span></span></div>
...
<button class="btn" type="reset">
                                ...
                                <?php
                                	if($row_getdetails['status']=='11' || $row_getdetails['status']=='22')
														{
														?>
                                                        <a href="gapanalysischeck.php?fullnames=<?php echo $_SESSION['MM_full_names']."(".$_SESSION['MM_USR_EMAIL'].")"; ?>&status=00&gap_id=<?php echo $row_getdetails['gap_id']; ?>&request_id=<?php echo $colname_getrequestid; ?>&moduleid=<?php echo $colname_getmoduleid; ?>"> <button class="btn btn-xs btn-danger">
                                	...
                                	if($row_getdetails['status']=='00')
														...
														?>
                                                    <a href="gapanalysischeck.php?fullnames=<?php echo $_SESSION['MM_full_names']."(".$_SESSION['MM_USR_EMAIL'].")"; ?>&status=22&gap_id=<?php echo $row_getdetails['gap_id']; ?>&request_id=<?php echo $colname_getrequestid; ?>&moduleid=<?php echo $colname_getmoduleid; ?>"> <button class="btn btn-xs btn-success">
...
?>
        ...
        <i class="ace-icon fa fa-hand-o-right icon-animated-hand-pointer blue"></i><a href="gapanalysischeck.php?fullnames=<?php echo $_SESSION['MM_full_names']."(".$_SESSION['MM_USR_EMAIL'].")"; ?>&status=11&search_id_approve=<?php echo $search_ref; ?>&request_id=<?php echo $colname_getrequestid; ?>&moduleid=<?php echo $colname_getmoduleid; ?>&gap_id=<?php echo $row_getdetails['gap_id']; ?>"> <button class="btn btn-xs btn-success">
															<i class="ace-icon fa fa-check bigger-120">Approve</i>															</button></a>
                                                            
                                                              <i class="ace-icon fa fa-hand-o-right icon-animated-hand-pointer blue"></i><a href="#modal-addreject-<?php echo $row_getdetails['gap_id']; ?>" role="button" class="blue" data-toggle="modal">	
                                 <button class="btn btn-xs btn-danger"> Reject With Reason															</button></a> 
							  <div id="modal-addreject-<?php echo $row_getdetails['gap_id']; ?>" class="modal fade" tabindex="-1"><div class="modal-dialog"><div class="modal-content"><div class="modal-header no-padding">
												<div class="table-header">
													<button type="button" class="close" data-dismiss="modal" aria-hidden="true">
														<span class="white">&times;</span>													</button>
...
?>
 ...
 <a href="gapanalysischeckadd.php?request_id=<?php echo $row_getstudent['request_id']; ?>&moduleid=<?php echo $colname_getmoduleid; ?>" role="button" class="green">	
                                 <button class="btn btn-xs btn-primary">
											  <i class="ace-icon smaller-80 green"></i>Add Data
</button></a> 
     ...
     <input type="hidden" id="added_by" name="added_by" value="<?php echo $_SESSION['MM_full_names']."(".$_SESSION['MM_USR_EMAIL'].")"; ?>"/>
           <input type="hidden" id="date_added" name="date_added" value="<?php echo date('Y-m-d H:m:s');?>"/>
                                     	<div class="space-10"></div>
																...
																<div class="col-sm-8"><span id="sprytextfield1">
																  <input class="form-control" type="text" id="gap_name" name="gap_name" required/>
											    <span class="textfieldRequiredMsg">*</span></span></div>
			<br/>
            <div class="space-10"></div>
            	<label class="col-sm-4">From Date</label>
															  ...
															  <div class="col-sm-8"><span id="sprytextfield4">
															    <input class="form-control" type="text" id="from_date" name="from_date"  required/>
														      <span class="textfieldRequiredMsg">*</span></span></div>
                                <br/>
            <div class="space-10"></div>
            	<label class="col-sm-4">To Date</label>
															  ...
															  <div class="col-sm-8"><span id="sprytextfield4">
															    <input class="form-control" type="text" id="to_date" name="to_date"  required/>
														      <span class="textfieldRequiredMsg">*</span></span></div>
