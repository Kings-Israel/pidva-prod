...
if($totalRows_getstudent > 0)
{
 ...
 $insertSQL = sprintf("INSERT INTO pel_individual_id (identity_type, identity_name, identity_number, status, date_of_birth, added_by, gender, data_source, data_notes, date_added, search_id, identity_photo, citizenship, expiry_date, identity_country,identity_holder_photo, module_name) VALUES (%s, %s, %s,%s, %s, %s, %s, %s,  %s, now(), %s, %s, %s, %s, %s, %s, %s)",
					   ...
					   GetSQLValueString(strtoupper($row_getstudent['expiry_date']), "text"),
					   ...
					   GetSQLValueString("passportcheck", "text"));
...
$errorcode = '<div class="alert alert-danger">
										 ...
										 Details of the PASSPORT Data havent been added.
											<br />
										</div>';
...
{ 
  $updateGoTo = "passportcheck.php?request_id=$colname_getrequestid&moduleid=$colname_getmoduleid";
 /* if (isset($_SERVER['QUERY_STRING'])) {
...
else
{
	$errorcode = '<div class="alert alert-danger">
										 ...
										 NO Previous Details of PASSPORT found
											<br />
										</div>';
...
$rawname = $_FILES['identity_photo']['name'];
	  ...
	  $file="passportphotos/".$a."_". $_FILES["identity_photo"]["name"];

    require_once "../../uploads.php";
    $prefix = "identity_photo";
    $filenameuploaded = uploadFile($prefix,"individual-passportphotos",$a."_".$_FILES[$prefix]["name"]);
...
$rawname = $_FILES['identity_holder_photo']['name'];
	  ...
	  $file="individualpassportphotos/".$a."_". $_FILES["identity_holder_photo"]["name"];

    require_once "../../uploads.php";
    $prefix = "identity_holder_photo";
    $filenameuploaded_individual = uploadFile($prefix,"individual-individualpassportphotos",$a."_".$_FILES[$prefix]["name"]);
...
$filenameuploaded_individual = $_POST['identity_holder_photo2']; 
  ...
  $updateSQL = sprintf("UPDATE pel_individual_id SET identity_type=%s, identity_name=%s, identity_number=%s, status=%s, date_of_birth=%s, added_by=%s, gender=%s, data_source=%s, data_notes=%s, date_added=now(), search_id=%s, identity_photo=%s, citizenship=%s, expiry_date=%s, identity_country=%s,identity_holder_photo=%s WHERE identity_id=%s",
					   ...
					   GetSQLValueString(strtoupper($_POST['expiry_date']), "text"),
...
$errorcode = '<div class="alert alert-danger">
											...
											<strong>
											 ...
											 Details of the PASSPORT were not updated succesfully.
											<br />
										</div>';
...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Individual Passport Details Data Management - Peleza Admin</title>
					...
					<div class="breadcrumbs" id="breadcrumbs">
					  <script type="text/javascript">
						...
						<ul class="breadcrumb">
							...
							<li class="active">Individual Passport Details</li>
						</ul><!-- /.breadcrumb -->
...
<div class="row">
									<div class="col-xs-12">
									  ...
									  <h3 align="left" class="header smaller lighter blue">Add Individual Passport Details</h3>
                                      </div>
                                         <!--   <div  class="col-xs-6">
...
$query_getdetails = "SELECT * FROM pel_individual_id WHERE search_id = '".$search_ref."' and module_name='passportcheck'";
           ...
           <input type="hidden" id="date_added" name="date_added" value="<?php echo date('Y-m-d H:m:s');?>"/>
           						...
           						<div class="space-10"></div>
                                                           ...
                                                           <option  value="<?php echo $row_getdetails['identity_type']; ?>"><?php echo $row_getdetails['identity_type']; ?></option>
                                                                ...
                                                                <option value="EAST AFRICA PASSPORT">EAST AFRICA PASSPORT</option>
                                                             </select>
											 </div>
...
$totalRows_getcountries = mysqli_num_rows($getcountries);
								...
								<br/><br/>
														...
														<label class="col-sm-4">Expiry Date</label>
															  ...
															  <div class="col-sm-7">
															    <input  value="<?php echo $row_getdetails['expiry_date']; ?>" type="text" id="expiry_date" name="expiry_date"/>
														   </div>
					<br/>
					...
					<br/>
                    						...
                    						<div class="space-10"></div>
														...
														<label class="col-sm-4">Passport Photo</label>

														<div class="col-sm-8">
															 Current Photo <br/>
                                                             	<img width="200px" height="200px" src="<?php echo $row_getdetails['identity_photo']; ?>" alt="Passport Photos">
							...
							<br/>
                    						...
                    						<div class="space-10"></div>
														...
														<div class="col-sm-8">
															 Current Photo <br/>
                                                             	<img width="200px" height="200px" src="<?php echo $row_getdetails['identity_holder_photo']; ?>" alt="ID Photos">
		...
		<textarea name="data_notes" id="editorCopy" required style="display:none;"><?php echo $row_getdetails['data_notes']; ?></textarea>
	</div>  <br/>   
															<div class="space-10"></div>
...
<button class="btn" type="reset">
                                ...
                                <?php
                                	if($row_getdetails['status']=='11' || $row_getdetails['status']=='22')
														{
														?>
                                                        <a href="passportcheck.php?fullnames=<?php echo $_SESSION['MM_full_names']."(".$_SESSION['MM_USR_EMAIL'].")"; ?>&status=00&identity_id=<?php echo $row_getdetails['identity_id']; ?>&request_id=<?php echo $colname_getrequestid; ?>&moduleid=<?php echo $colname_getmoduleid; ?>"> <button class="btn btn-xs btn-danger">
                                	...
                                	if($row_getdetails['status']=='00')
														...
														?>
                                                    <a href="passportcheck.php?fullnames=<?php echo $_SESSION['MM_full_names']."(".$_SESSION['MM_USR_EMAIL'].")"; ?>&status=22&identity_id=<?php echo $row_getdetails['identity_id']; ?>&request_id=<?php echo $colname_getrequestid; ?>&moduleid=<?php echo $colname_getmoduleid; ?>"> <button class="btn btn-xs btn-success">
...
<?php
                                               ...
                                               <thead> 
                                                ...
                                                <strong>PHOTO:</strong>
                                                    ...
                                                    <td  colspan="6">
                                                <strong>PASSPORT IMAGE PHOTO:</strong>
                                                        </td> 
                                                    
                                                          </tr></thead>
                                                    <tr>
                                                    <td colspan="5"><img width="400px" src="<?php echo $row_getdetails['identity_holder_photo']; ?>">
                                   </td>
                                                      <td colspan="6"><img width="400px" src="<?php echo $row_getdetails['identity_photo']; ?>">
                                   </td></tr>
                                    <thead> 
                                                 	 	<tr>	  <td  colspan="11">
                                                <strong>NOTES:</strong>
...
$totalRows_getcountries = mysqli_num_rows($getcountries);
								...
								<br/><br/>
														...
														<label class="col-sm-4">expiry_date</label>
