...
$colname_getsocial_media_id = "-1";
if (isset($_GET['social_media_id_move'])) {
    $colname_getsocial_media_id = $_GET['social_media_id_move'];
}
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "editdetails")) {
    ...
    if (is_uploaded_file($_FILES['photo']['tmp_name'])) {
        ...
        error_log("Wants to start file upload");

        require_once "../../uploads.php";
        $prefix = "photo";
        $filenameuploaded = uploadFile($prefix, "individual-socialmediaphotos", $a . "_" . $_FILES[$prefix]["name"]);

        error_log("Got filepath $filenameuploaded ");

    } else {
        error_log("No uploaded file");

        $filenameuploaded = $_POST['photo2'];

    }
    $editorCopy_post = isset($_POST['editorCopy_post']) ? $_POST['editorCopy_post'] : "";
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "newdetails")) {
    if (is_uploaded_file($_FILES['photo']['tmp_name'])) {
        ...
        error_log("Wants to upload filed");
...
-->
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <h3 align="left" class="header smaller lighter blue">Add Individual Social Media
                                        Details</h3>
                                </div>
                                <!--   <div  class="col-xs-6">
                         ...
                         <button class="btn btn-white btn-info btn-bold">
                                ...
                                <div>
                                    ...
                                    <a href="socialmediacheck.php?request_id=<?php echo $row_getstudent['request_id']; ?>&moduleid=<?php echo $colname_getmoduleid; ?>"
                                    ...
                                    <?php
                                    if (isset($_GET['request_id']) && isset($_GET['moduleid']) && !isset($_GET['social_media_id_move'])) {

                                        ?>

                                        <form enctype="multipart/form-data" method="POST"
                                              action="<?php echo $editFormAction; ?>" class="form-horizontal"
                                              name="newdetails">
                                            <input type="hidden" id="request_id" name="request_id"
                                                   value="<?php echo $colname_getrequestid; ?>"/>
                                            <input type="hidden" id="moduleid" name="moduleid"
                                                   value="<?php echo $colname_getmoduleid; ?>"/>
                                            ...
                                            <input type="hidden" id="added_by" name="added_by"
                                                   value="<?php echo $_SESSION['MM_full_names'] . "(" . $_SESSION['MM_USR_EMAIL'] . ")"; ?>"/>
                                            ...
                                            <div class="col-sm-8"><span id="sprytextfield4">
															    <input class="form-control" type="text"
                                                                       ...
                                                                       name="social_media_handle" required/>
														      <span class="textfieldRequiredMsg">*</span></span></div>
                                            ...
                                            <div class="col-sm-7"><span id="sprytextfield8">
															    <input class="form-control" type="text" id="data_source"
                                                                       name="data_source"/>
														      <span class="textfieldRequiredMsg">*</span></span></div>
                                            <br/>
                                            <div class="space-10"></div>
                                            ...
                                            <div class="col-sm-8">
                                                <select class="chosen-select form-control" name="adverse_status"
                                                        id="adverse_status" data-placeholder="Choose Adverse Status..."
                                                        required>
                                                    <!--  <select name="client_industry" id="client_industry">-->
                                                    <option value="">Adverse Status</option>
                                                    <option value="NO ADVERSE MENTION FOUND">NO ADVERSE MENTION FOUND
                                                    </option>
                                            ...
                                            <div class="col-sm-12">
                                                    ...
                                                    <div id="editControls">
                                                        ...
                                                        <div class="btn-group">
                                                            ...
                                                            <a class="btn btn-xs btn-default" data-role="italic"
                                                               href="#" title="Italic"><i class="fa fa-italic"></i></a>
                                                            <a class="btn btn-xs btn-default" data-role="underline"
                                                               href="#" title="Underline"><i
                                                                        class="fa fa-underline"></i></a>
                                                            <a class="btn btn-xs btn-default" data-role="strikeThrough"
                                                               href="#" title="Strikethrough"><i
                                                                        class="fa fa-strikethrough"></i></a>
                                                        </div>
                                                        <div class="btn-group">
                                                            <a class="btn btn-xs btn-default" data-role="indent"
                                                               href="#" title="Blockquote"><i class="fa fa-indent"></i></a>
                                                ...
                                                <div class="clearfix form-actions">
                                                    <div class="col-md-offset-3 col-md-9">
                                                        <button onClick="submit" type="submit" value="submit"
                                    ...
                                    <?php
                                    if (isset($_GET['social_media_id_move']) && isset($_GET['request_id'])) {

                                    $social_media_id = $colname_getsocial_media_id;
                                    $query_getdetails = "SELECT * FROM pel_data_social_media WHERE social_media_id = '" . $social_media_id . "'";
                                    ...
                                    <div class="col-lg-12" align="center"><h3 align="left"
                                                                              class=" smaller lighter blue"><strong>SOCIAL
                                                MEDIA CHECK DETAILS: </strong>
                                        </h3>
                                    ...
                                    <div class="modal-body padding">
                                        <form enctype="multipart/form-data" method="POST"
                                            ...
                                            <input type="hidden" id="social_media_id" name="social_media_id"
                                                   value="<?php echo $row_getdetails['social_media_id']; ?>"/>
                                            ...
                                            <div class="col-sm-8"><span id="sprytextfield1">
																  <input type="text" id="website" name="website"
                                                                         value="<?php echo $row_getdetails['website']; ?>"
                                                                         required/>
											    <span class="textfieldRequiredMsg">*</span></span></div>
                                            <br/>
                                            <div class="space-10"></div>
                                            ...
                                            <div class="col-sm-8"><span id="sprytextfield4">
															    <input type="text"
                                                                       value="<?php echo $row_getdetails['social_media_handle']; ?>"
                                                                       id="social_media_handle"
                                                                       name="social_media_handle" required/>
														      <span class="textfieldRequiredMsg">*</span></span></div>
                                            ...
                                            <div class="col-sm-7"><span id="sprytextfield8">
															    <input value="<?php echo $row_getdetails['data_source']; ?>"
                                                                       type="text" id="data_source" name="data_source"/>
														      <span class="textfieldRequiredMsg">*</span></span></div>
                                            <br/>
                                            <div class="space-10"></div>
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <img width="200px" height="200px"
                                                     src="<?php echo $row_getdetails['photo']; ?>"
                                                     alt="Social Media Photos">

                                                <input id="photo2" name="photo2" type="hidden"
                                                       value="<?php echo $row_getdetails['photo']; ?>"/>
                                            </div>
                                            <br/>
                                            ...
                                            <div class="col-sm-12">
                                                <div id="editparent">
                                                    ...
                                                    <div id="editor"
                                                         contenteditable><?php echo $row_getdetails['data_notes']; ?></div>
                                                    <textarea name="data_notes" id="editorCopy" required
                                                              style="display:none;"><?php echo $row_getdetails['data_notes']; ?></textarea>
                                                </div>
                                            ...
                                            <div class="clearfix form-actions">
                                                <div class="col-md-offset-3 col-md-9">
                                                    <button onClick="submit" type="submit" value="submit" type="button"
                                                            class="btn btn-info">
                                                        <!--<button onClick="submit" class="btn btn-info" type="button">-->
                                                        <i class="ace-icon fa fa-check bigger-110"></i>
                                                        Save
