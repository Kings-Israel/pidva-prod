...
echo  $data_notes = $_POST[$data_notesn]; 
...
<td>
	...
	<i class="ace-icon fa fa-hand-o-right icon-animated-hand-pointer blue"></i><a href="#modal-editdetails-<?php echo $row_getdetails['social_media_id']; ?>" role="button" class="green" data-toggle="modal">	
 ...
 <input type="hidden" id="moduleid" name="moduleid" value="<?php echo $colname_getmoduleid; ?>"/>
	...
	</div>     <input id="editorCopy_post" name="editorCopy_post" type="hidden" value="<?php echo $n;?>"/>   
