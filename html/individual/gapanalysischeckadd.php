...
if (isset($_GET['gap_id_move'])) {
  $colname_getgap_id = $_GET['gap_id_move'];
}
...
<?php
       if (isset($_GET['gap_id_move']) &&  isset($_GET['request_id'])) {
	
$gap_id = $colname_getgap_id;
$query_getdetails = "SELECT * FROM pel_individual_gap_data WHERE gap_id = '".$gap_id."'";
...
if($totalRows_getdetails>0)
{
    ...
    <div class="col-lg-12" align="center"> <h3 align="left" class=" smaller lighter blue"><strong>GAP CHECK DETAILS: </strong> 
</h3> 
...
<?php
if (isset($_GET['request_id']) && isset($_GET['moduleid']) && !isset($_GET['gap_id_move'])) {
