...
$a = $_POST['search_id']."-".$date_insert; 
 ...
 $data_notes = $_POST[$data_notesn]; 
  ...
  $updateSQL = sprintf("UPDATE pel_data_mobile_number SET line_provider=%s, status=%s, mobile_number=%s, added_by=%s, search_id=%s, data_source=%s, data_notes=%s, adverse_status=%s, date_added=now() WHERE mobile_number_id=%s",
                       GetSQLValueString(strtoupper($_POST['line_provider']), "text"),
					   ...
					   GetSQLValueString($_POST['mobile_number_id'], "text"));
...
else
{
  ...
  $updateGoTo = "mobilenumbercheck.php?request_id=$colname_getrequestid&moduleid=$colname_getmoduleid";
 /* if (isset($_SERVER['QUERY_STRING'])) {
...
$insertSQL = sprintf("INSERT INTO pel_data_mobile_number (line_provider, status, mobile_number, added_by, search_id, data_source, data_notes, adverse_status, date_added) VALUES (%s, %s, %s,%s, %s, %s, %s, %s, now())",
                       GetSQLValueString(strtoupper($_POST['line_provider']), "text"),
					   GetSQLValueString("22", "text"),
                       GetSQLValueString(strtoupper($_POST['mobile_number']), "text"),
                       GetSQLValueString($_POST['added_by'], "text"),
...
$deleteSQLreject = sprintf("UPDATE pel_data_mobile_number SET status=%s, review_status=%s, verified_by=%s, verified_date=now(), review_notes=%s WHERE search_id=%s and mobile_number_id=%s",
					   ...
					   GetSQLValueString($_POST['review_notes'], "text"),
						...
						GetSQLValueString($_POST['mobile_number_id'], "int"));
					   mysqli_select_db($connect,$database_connect);
...
if ((isset($_GET['mobile_number_id'])) && ($_GET['mobile_number_id'] != "")) {
if($_GET['status']=='00')
{
  $deleteSQL = sprintf("UPDATE pel_data_mobile_number SET status=%s, added_by=%s, date_added=now() WHERE mobile_number_id=%s",
                       GetSQLValueString($_GET['status'], "text"),
					   GetSQLValueString($_GET['fullnames'], "text"),
					    GetSQLValueString($_GET['mobile_number_id'], "int"));
					   mysqli_select_db($connect,$database_connect);
...
if($_GET['status']=='11')
{
   ...
   $deleteSQL2 = sprintf("UPDATE pel_data_mobile_number SET status=%s, review_status=%s, verified_by=%s, verified_date=now() WHERE search_id=%s and mobile_number_id=%s",
                       GetSQLValueString($_GET['status'], "text"),
...
$errorcode = '<div class="alert alert-danger">
										 ...
										 Details of the data have not been blocked
											<br />
										</div>';
...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Individual Mobile Number Details Data Management - Peleza Admin</title>
					...
					<div class="breadcrumbs" id="breadcrumbs">
					  <script type="text/javascript">
						...
						<ul class="breadcrumb">
							...
							<li class="active">Individual Mobile Number Details</li>
						</ul><!-- /.breadcrumb -->
...
<div class="row">
									<div class="col-xs-12">
									  ...
									  <h3 align="left" class="header smaller lighter blue">Add Individual Mobile Number Details</h3>
                                      </div>
                                         <!--   <div  class="col-xs-6">
...
$query_getdetails = "SELECT * FROM pel_data_mobile_number WHERE search_id = '".$search_ref."'";
...
if($totalRows_getdetails>0)
{
	?> 
										...
										<div class="col-lg-12" align="center"> <h3 align="left" class=" smaller lighter blue"><strong>MOBILE NUMBER CHECK DETAILS: </strong> 
</h3> 
<?php
$n = 1;
do
										...
										<thead>
													<tr>									
													  <th>PROVIDER:</th>                                                    
                                                   	...
                                                   	<tr>
<td>
                                                   <a href="#"><?php echo $row_getdetails['line_provider']; ?> </a>																								</td>
	...
	<i class="ace-icon fa fa-hand-o-right icon-animated-hand-pointer blue"></i><a href="mobilenumbercheckadd.php?request_id=<?php echo $row_getstudent['request_id']; ?>&mobile_number_id_move=<?php echo $row_getdetails['mobile_number_id']; ?>&moduleid=<?php echo $colname_getmoduleid; ?>" role="button" class="green" data-toggle="modal">	
                                 <button class="btn btn-xs btn-info">  
															<i class="ace-icon fa fa-pencil bigger-120"></i>															</button></a>

   <div id="modal-editdetails-<?php echo $row_getdetails['mobile_number_id']; ?>" class="modal fade" tabindex="-1"><div class="modal-dialog"><div class="modal-content"><div class="modal-header no-padding">
 ...
 <input type="hidden" id="moduleid" name="moduleid" value="<?php echo $colname_getmoduleid; ?>"/>
										<input type="hidden" id="mobile_number_id" name="mobile_number_id" value="<?php echo $row_getdetails['mobile_number_id']; ?>"/>
     ...
     <input type="hidden" id="added_by" name="added_by" value="<?php echo $_SESSION['MM_full_names']."(".$_SESSION['MM_USR_EMAIL'].")"; ?>"/>
           <input type="hidden" id="date_added" name="date_added" value="<?php echo date('Y-m-d H:m:s');?>"/>
           						...
           						<div class="space-10"></div>
											...
											<label class="col-sm-4">Line Provider Name</label>

											<div class="col-sm-8">
												<!-- <span id="sprytextfield1">
													<input type="text" id="line_provider" name="line_provider" value="<?php echo $row_getdetails['line_provider']; ?>"  required/>
													<span class="textfieldRequiredMsg">*</span>
												</span> -->
												
                                                <select class="chosen-select form-control" type="text" id="line_provider" 
                                                    name="line_provider" data-placeholder="Choose Line Provider..." required>
                                                    <option value="">Line Provider...</option>
            ...
            <div class="space-10"></div>
            	<label class="col-sm-4">Mobile Number</label>
															  ...
															  <div class="col-sm-8"><span id="sprytextfield4">
															    <input  type="text" value="<?php echo $row_getdetails['mobile_number']; ?>" id="mobile_number" name="mobile_number"  required/>
...
<button class="btn" type="reset">
                                ...
                                <?php
                                	if($row_getdetails['status']=='11' || $row_getdetails['status']=='22')
														{
														?>
                                                        <a href="mobilenumbercheck.php?fullnames=<?php echo $_SESSION['MM_full_names']."(".$_SESSION['MM_USR_EMAIL'].")"; ?>&status=00&mobile_number_id=<?php echo $row_getdetails['mobile_number_id']; ?>&request_id=<?php echo $colname_getrequestid; ?>&moduleid=<?php echo $colname_getmoduleid; ?>"> <button class="btn btn-xs btn-danger">
                                	...
                                	if($row_getdetails['status']=='00')
														...
														?>
                                                    <a href="mobilenumbercheck.php?fullnames=<?php echo $_SESSION['MM_full_names']."(".$_SESSION['MM_USR_EMAIL'].")"; ?>&status=22&mobile_number_id=<?php echo $row_getdetails['mobile_number_id']; ?>&request_id=<?php echo $colname_getrequestid; ?>&moduleid=<?php echo $colname_getmoduleid; ?>"> <button class="btn btn-xs btn-success">
...
?>
        ...
        <i class="ace-icon fa fa-hand-o-right icon-animated-hand-pointer blue"></i><a href="mobilenumbercheck.php?fullnames=<?php echo $_SESSION['MM_full_names']."(".$_SESSION['MM_USR_EMAIL'].")"; ?>&status=11&search_id_approve=<?php echo $search_ref; ?>&request_id=<?php echo $colname_getrequestid; ?>&moduleid=<?php echo $colname_getmoduleid; ?>&mobile_number_id=<?php echo $row_getdetails['mobile_number_id']; ?>"> <button class="btn btn-xs btn-success">
															<i class="ace-icon fa fa-check bigger-120">Approve</i>															</button></a>
                                                            
                                                              <i class="ace-icon fa fa-hand-o-right icon-animated-hand-pointer blue"></i><a href="#modal-addreject-<?php echo $row_getdetails['mobile_number_id']; ?>" role="button" class="blue" data-toggle="modal">	
                                 <button class="btn btn-xs btn-danger"> Reject With Reason															</button></a> 
							  <div id="modal-addreject-<?php echo $row_getdetails['mobile_number_id']; ?>" class="modal fade" tabindex="-1"><div class="modal-dialog"><div class="modal-content"><div class="modal-header no-padding">
												<div class="table-header">
													<button type="button" class="close" data-dismiss="modal" aria-hidden="true">
														<span class="white">&times;</span>													</button>
...
<i class="ace-icon fa fa-hand-o-right icon-animated-hand-pointer blue"></i><a href="#"  role="button" class="orange"data-toggle="modal">	
    ...
    -->
    <a href="mobilenumbercheckadd.php?request_id=<?php echo $row_getstudent['request_id']; ?>&moduleid=<?php echo $colname_getmoduleid; ?>" role="button" class="green">	
                                 <button class="btn btn-xs btn-primary">
     ...
     <input type="hidden" id="added_by" name="added_by" value="<?php echo $_SESSION['MM_full_names']."(".$_SESSION['MM_USR_EMAIL'].")"; ?>"/>
           <input type="hidden" id="date_added" name="date_added" value="<?php echo date('Y-m-d H:m:s');?>"/>
                                     	<div class="space-10"></div>
											...
											<div class="col-sm-8">
												<!-- <span id="sprytextfield1">
													<input class="form-control" type="text" id="line_provider" name="line_provider" required/>
											    	<span class="textfieldRequiredMsg">*</span>
												</span> -->	
                                                <select class="chosen-select form-control" type="text" id="line_provider" 
                                                    name="line_provider" data-placeholder="Choose Line Provider..." required>
