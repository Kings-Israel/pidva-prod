...
$query_getallsearches = "SELECT * FROM pel_searches WHERE search_status IN ('11','22')  ORDER BY search_date DESC";
        ...
        <div class="main-content-inner">
            ...
            <div class="breadcrumbs" id="breadcrumbs">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active">Edcheck Searches</li>
                </ul><!-- /.breadcrumb -->
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="col-xs-12">
                                    ...
                                    <h3 align="left" class="header smaller lighter blue">EDCHECK SEARCHES DONE</h3>
                                </div>
                                <!--    <div  class="col-xs-6">
                          ...
                          <button class="btn btn-white btn-info btn-bold">
                                ...
                                <div class="table-header">
                                    Results for "Edcheck Searches Done"
                                </div>
                                    ...
                                    <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                        ...
                                        do { ?>
                                            <tr>
                                                ...
                                                <td><?php echo crypt($row_getallsearches['student_name'], 'st'); ?></td>
                                                <td><?php echo crypt($row_getallsearches['institution_name'], 'st'); ?></td>
                                                <td><?php echo $row_getallsearches['search_plan']; ?></td>
                                                ...
                                                <td class="hidden-480"><?php
                                                    ...
                                                    if ($row_getallsearches['search_status'] == '11') {
                                                        ?>

                                                        <span class="label label-sm label-success">SUCCESS</span>
                                                        <?php
                                                    }
                                                    if ($row_getallsearches['search_status'] == '00') {
                                                        ?>
                                                        <span class="label label-sm label-danger">Deactivated</span>
                                                        <?php
                                                    }
                                                    if ($row_getallsearches['search_status'] == '22') {
                                                        ?>
                                                        <span class="label label-sm label-warning">Not Found</span>
                                                        <?php
                                                    }
                                                ...
                                                <!--<td>
                                                          <div class="hidden-sm hidden-xs action-buttons">
                                                                     ...
                                                                     <a href="#modal-viewclient-<?php echo $row_getallsearches['client_id']; ?>" role="button" class="green" data-toggle="modal">	    <button class="btn btn-xs btn-primary">  
																		<i class="ace-icon fa fa-search-plus bigger-130"></i>																	</button></a>  
                                                                 
                                                                 
            
                                                                 
<div id="modal-viewclient-<?php echo $row_getallsearches['client_id']; ?>" class="modal fade" tabindex="-1">
...
<table width="100%" border="0">
  <tr>
    ...
    <td><?php echo $row_getallsearches['client_first_name']; ?></td>
    <td><strong>Other Names:</strong></td>
    <td><?php echo $row_getallsearches['client_last_name']; ?></td>
  ...
  <tr>
   ...
   <tr>
    ...
    <td><?php echo $row_getallsearches['client_mobile_number']; ?></td> <td><strong>Client Email Address:</strong></td>
    <td><?php echo $row_getallsearches['client_email_address']; ?></td>
  ...
  <tr>
   ...
   <tr> <td><strong>Country</strong></td>
    <td><?php echo $row_getallsearches['client_country']; ?></td>
    <td><strong>Industry:</strong></td>
    <td><?php echo $row_getallsearches['client_industry']; ?></td>
  ...
  <tr>
    ...
    <tr> <td><strong>Institution Status:</strong></td>
    <td><button type="button" class="btn disabled btn-white btn-primary"><?php if ($row_getallsearches['search_status'] == '11') {
                                                    ?>
                                                       ACTIVE <?php
                                                }
                                                if ($row_getallsearches['search_status'] == '00') {
    ...
    <td><?php echo $row_getallsearches['client_parent_company']; ?></td>
  </tr>
   <tr>
    <td colspan="4"><br/></td>
  </tr>
    ...
    <td><button type="button" class="btn disabled btn-white btn-primary"><?php echo $row_getallsearches['added_by']; ?></button></td>
    <td><strong>Added Date:</strong></td>
    <td><button type="button" class="btn disabled btn-white btn-primary"><?php echo $row_getallsearches['added_date']; ?></button></td>
  </tr>
  <tr>
    <td colspan="4"><br/></td>
  </tr>
    ...
    <td><button type="button" class="btn disabled btn-white btn-primary"><?php echo $row_getallsearches['verified_by']; ?></button></td>
    <td><strong>Verified Date:</strong></td>
    <td><button type="button" class="btn disabled btn-white btn-primary"><?php echo $row_getallsearches['verified_date']; ?></button></td>
  </tr><tr>
    <td colspan="4"><br/></td>
  </tr>
