...
mysqli_select_db($connect, $database_connect);
$query_getallsearches = "SELECT * FROM pel_individual_id WHERE status IN ('00','33','44','22','11') and identity_id > 3500 ORDER BY identity_id DESC";
                                    ...
                                    <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                        ...
                                        do {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="#"><?php echo $row_getallsearches['token_number']; ?></a>
                                                </td>
                                                <td>
                                                    <a href="#"><?php echo $row_getallsearches['identity_number']; ?></a>
                                                </td>

                                                <td><?php echo $row_getallsearches['identity_type']; ?></td>
                                                <td><?php echo $row_getallsearches['identity_name']; ?></td>
                                                <td><?php echo $row_getallsearches['date_of_birth']; ?></td>
                                                <td><?php echo $row_getallsearches['gender']; ?></td>
                                                <td><?php echo $row_getallsearches['individual_id']; ?></td>
                                                <td><?php echo $row_getallsearches['date_added']; ?></td>


                                                <td><?php


                                                    if ($row_getallsearches['iprs_photo'] == '') {
                                                    } else {


                                                        ?><a
                                                        href="#modal-viewimage-<?php echo $row_getallsearches['identity_number']; ?>"
                                                        data-toggle="modal">    <img
                                                                src="https://peleza.fra1.digitaloceanspaces.com/demo/searches-photos/<?php echo $row_getallsearches['identity_number'] . ".png"; ?>"
                                                    ...
                                                    <div id="modal-viewimage-<?php echo $row_getallsearches['identity_number']; ?>"
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body padding">
                                                                    <img src="https://peleza.fra1.digitaloceanspaces.com/demo/searches-photos/<?php echo $row_getallsearches['identity_number'] . ".png"; ?>"/>
                                                ...
                                                <td class="hidden-480"><?php
                                                    ...
                                                    if ($row_getallsearches['status'] == '22') {
                                                        ?>
                                                        <span class="label label-sm label-danger">NO DATA</span>
                                                        <?php
                                                    }
                                                    ?>  </td>
...
<?php
 ...
 <tr>
  ...
  <tr>
   ...
   <?php
                                                $filetracker = $row_getallsearches['file_tracker'];
...
Inner Join pel_psmt_files ON pel_psmt_request.file_tracker = pel_psmt_files.psmtfile_filetoken WHERE pel_psmt_request.file_tracker = '$filetracker'";
  ...
  <tr>
   ...
   <?php
                                            ...
                                            <div id="modal-notify-<?php echo $row_getallsearches['request_id']; ?>"
                                                 class="modal fade" tabindex="-1">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header no-padding">
                                                        ...
                                                        <div class="modal-body no-padding">
                                                            <form class="form-horizontal" ENCTYPE='multipart/form-data'
                                                                ...
                                                                <input type="hidden" id="ID" name="ID"
                                                                       ...
                                                                       value="<?php echo $row_getallsearches['request_id']; ?>"/>

                                                                <input type="hidden" id="client_id" name="client_id"
                                                                       class="col-xs-10 col-sm-5"
                                                                       value="<?php echo $row_getallsearches['client_id']; ?>"/>

                                                                <input type="hidden" id="notify_by" name="notify_by"
                                                                       class="col-xs-10 col-sm-5"
                                                                       value="<?php echo $_SESSION['MM_full_names']; ?>"/>
                                                                <input type="hidden" id="notify_date" name="notify_date"
                                                                       class="col-xs-10 col-sm-5"
                                                                       value="<?php echo date('d-m-Y'); ?>"/>

                                                                <input type="hidden" id="status" name="status"
                                                                       class="col-xs-10 col-sm-5" value="11"/>

                                                                <br/>
                                                                <div class="space-10"></div>
                                                                <label class="col-sm-4 control-label no-padding-right"
                                                                       for="form-field-pass1">Data Set Name</label>
                                                                <input type="hidden" id="bg_dataset_name"
                                                                       name="bg_dataset_name" class="col-xs-10 col-sm-5"
                                                                       value="<?php echo $row_getallsearches['bg_dataset_name']; ?>"/>
                                                                ...
                                                                <div class="space-10"></div>
                                                                <label class="col-sm-4 control-label no-padding-right"
                                                                       for="form-field-pass1">Package</label> <input
                                                                        type="hidden" id="request_plan"
                                                                        name="request_plan" class="col-xs-10 col-sm-5"
                                                                        value="<?php echo $row_getallsearches['request_plan']; ?>"/>
                                                                ...
                                                                <div class="space-10"></div>
                                                                <label class="col-sm-4 control-label no-padding-right"
                                                                       for="form-field-pass1">Request Ref Number</label>
                                                                <input type="hidden" id="request_ref_number"
                                                                       name="request_ref_number"
                                                                       class="col-xs-10 col-sm-5"
                                                                       value="<?php echo $row_getallsearches['request_ref_number']; ?>"/>
                                                                ...
                                                                <div class="space-10"></div>
                                                                <label class="col-sm-4 control-label no-padding-right"
                                                                       for="form-field-pass1">Upload File<span
