...
foreach($_POST['course_id'] as $selected){
$togetcourse=$selected;
...
$insertSQL = sprintf("INSERT INTO pel_edu_inst_courses (institution_id, course_id, course_name, faculty_name, faculty_id, course_code, added_date, added_by) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['institution_id'], "text"),
                       GetSQLValueString($togetcourse, "text"),
...
$errorcode ='<div class="alert alert-danger">
											...
											Please Choose Atleast One Course.
											<br />
										</div>';
...
mysqli_select_db($connect,$database_connect);
$query_getcourses = "SELECT * FROM pel_edu_courses where status='11' ORDER BY course_name ASC";
...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Assign Course to Institution - Peleza Admin</title>
...
<div class="row">
                                    ...
                                    <div  class="col-xs-6">
									  ...
									  <h3 align="left" class="header smaller lighter blue">ASSIGN COURSE TO INSTITUTIONS</h3>
                                      </div>
											...
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
                                                  ...
                                                  <tr>
                                                     	<td class="center">
														<label class="pos-rel">
																<input type="checkbox" class="ace" name="course_id[]" id="course_id[]" value="<?php echo $row_getcourses['course_id']; ?>">
																<span class="lbl"></span>												</label>														</td>
                                                      
                                               <td>
                                                        <a href="#"><?php echo $row_getcourses['faculty_name']; ?></a>														</td>
                                           <td><?php echo $row_getcourses['course_name']; ?></td>
                                                      <td><?php echo $row_getcourses['course_code']; ?></td>                  
                                                  
                                                      <td class="hidden-480"><?php 
														
														if($row_getcourses['status']=='11')
														{
														?>
