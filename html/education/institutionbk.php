...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "assigncourse")) {
  mysqli_select_db($connect,$database_connect);
$togetcourse = $_POST['course_id'];
$query_getcoursesdetails = "SELECT * FROM pel_edu_courses WHERE course_id='$togetcourse'";
...
$totalRows_getcoursesdetails = mysqli_num_rows($getcoursesdetails);
  ...
  $insertSQL = sprintf("INSERT INTO pel_edu_inst_courses (institution_id, course_id, course_name, faculty_name, course_code, added_date, added_by) VALUES (%s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['institution_id'], "text"),
                       ...
                       GetSQLValueString($row_getcoursesdetails['course_code'], "text"),
                       GetSQLValueString($_POST['added_date'], "text"),
					   GetSQLValueString($_POST['added_by'], "text"));
...
$rawname = $_FILES['inst_logo']['name'];
    ...
    $prefix = "inst_logo";
    $filenameuploaded = uploadFile($prefix,"education-logoimages",$a."_".$_FILES[$prefix]["name"]);
...
{?>
  <meta http-equiv="Refresh" content="1; url=institution.php">
