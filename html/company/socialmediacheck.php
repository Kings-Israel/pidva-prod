...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "editdetails")) {
	...
	if (is_uploaded_file($_FILES['photo']['tmp_name'])) {
		...
		$a = $_POST['social_media_handle'] . "-" . $_POST['search_id'] . "-" . $date_insert;
		...
		move_uploaded_file(
			...
			"socialmediaphotos/" . $a . "_" . $_FILES["photo"]["name"]
		);
	...
	$updateSQL = sprintf(
		"UPDATE pel_data_social_media SET website=%s, status=%s, social_media_handle=%s, added_by=%s, search_id=%s, data_source=%s, data_notes=%s, adverse_status=%s, date_added=now(), photo=%s WHERE social_media_id=%s",
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "newdetails")) {
	...
	$insertSQL = sprintf(
		"INSERT INTO pel_data_social_media (website, status, social_media_handle, added_by, search_id, data_source, data_notes, adverse_status, date_added, photo) VALUES (%s, %s, %s,%s, %s, %s, %s, %s, now(), %s)",
		GetSQLValueString(strtoupper($_POST['website']), "text"),
		GetSQLValueString("22", "text"),
		GetSQLValueString(strtoupper($_POST['social_media_handle']), "text"),
		GetSQLValueString($_POST['added_by'], "text"),
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "addreject")) {
	...
	$deleteSQLreject = sprintf(
		"UPDATE pel_data_social_media SET status=%s, review_status=%s, verified_by=%s, verified_date=now(), review_notes=%s WHERE search_id=%s and social_media_id=%s",
...
if ((isset($_GET['social_media_id'])) && ($_GET['social_media_id'] != "")) {
	if ($_GET['status'] == '00') {
		$deleteSQL = sprintf(
			"UPDATE pel_data_social_media SET status=%s, added_by=%s, date_added=now() WHERE social_media_id=%s",
...
if ((isset($_GET['search_id_approve'])) && ($_GET['search_id_approve'] != "")) {
	if ($_GET['status'] == '11') {
		...
		$deleteSQL2 = sprintf(
			"UPDATE pel_data_social_media SET status=%s, review_status=%s, verified_by=%s, verified_date=now() WHERE search_id=%s and social_media_id=%s",
			GetSQLValueString($_GET['status'], "text"),
...
<head>
	...
	<meta charset="utf-8" />
	<title>Company Social Media Details Data Management - Peleza Admin</title>
			...
			<div class="main-content-inner">
				...
				<div class="breadcrumbs" id="breadcrumbs">
					...
					<ul class="breadcrumb">
						...
						<li class="active">Company Social Media Details</li>
					</ul><!-- /.breadcrumb -->
...
-->
							<div class="row">
								<div class="col-xs-12">
									...
									<h3 align="left" class="header smaller lighter blue">Add Company Social Media Details</h3>
								</div>
								<!--   <div  class="col-xs-6">
								...
								<div>
									...
									?>
										...
										<div class="col-lg-12" align="center">
											<h3 align="left" class=" smaller lighter blue"><strong>SOCIAL MEDIA CHECK DETAILS: </strong>
											</h3>
											<?php
											do {
											?>
												...
												<table id="simple-table" class="table table-bordered table-hover">
													...
													<tr>
														<td>
															<a href="#"><?php echo $row_getdetails['website']; ?> </a>
														</td>
														...
														<td class="hidden-480">
															...
															<div id="modal-editdetails-<?php echo $row_getdetails['social_media_id']; ?>" class="modal fade" tabindex="-1">
																	...
																	<div class="modal-content">
																		...
																		<div class="modal-body padding">
																			<form enctype="multipart/form-data" method="POST" action="<?php echo $editFormAction; ?>" class="form-horizontal" name="editdetails">
																				...
																				<div class="col-sm-8">
																					Current Photo <br />
																					<img width="200px" height="200px" src="socialmediaphotos/<?php echo $row_getdetails['photo']; ?>" alt="Social Media Photos">
												...
												<table id="simple-table" class="table  table-striped  table-bordered table-hover">
													...
													<tr>
														<td width="50%"><img width="200px" src="socialmediaphotos/<?php echo $row_getdetails['photo']; ?>">
														</td>
														<td>
												...
												<div id="modal-addreject-<?php echo $row_getdetails['social_media_id']; ?>" class="modal fade" tabindex="-1">
													<div class="modal-dialog">
														<div class="modal-content">
															<div class="modal-header no-padding">
																<div class="table-header">
