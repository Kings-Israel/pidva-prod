	...
	if (mysqli_error($connect)) {
		$errorcode = '<div class="alert alert-danger">
											...
											<strong>
											 ...
											 Details of the Membership were not updated succesfully.
											<br />
										</div>';
	} else {

		$updateGoTo = "profflicenseverificationcheck.php?request_id=$colname_getrequestid&moduleid=$colname_getmoduleid";
		/* if (isset($_SERVER['QUERY_STRING'])) {
...
<head>
	...
	<meta charset="utf-8" />
	<title>Company Profffessional Membership Details Data Management - Peleza Admin</title>
			...
			<div class="main-content-inner">
				...
				<div class="breadcrumbs" id="breadcrumbs">
					...
					<ul class="breadcrumb">
						...
						<li class="active">Company Membership Details</li>
					</ul><!-- /.breadcrumb -->
...
-->
							<div class="row">
								<div class="col-xs-12">
									...
									<h3 align="left" class="header smaller lighter blue">Add Company Membership Details</h3>
								</div>
								<!--   <div  class="col-xs-6">
												...
												<table id="simple-table" class="table table-bordered table-hover">
													...
													<tr>
														...
														<td class="hidden-480">
																	...
																	<div class="modal-content">
																		...
																		<div class="modal-body padding">
																			<form enctype="multipart/form-data" method="POST" action="<?php echo $editFormAction; ?>" class="form-horizontal" name="editdetails">
																				...
																				<label class="col-sm-4">Memerbship Certificate</label>
															...
															?>
																<a href="profflicenseverificationcheck.php?fullnames=<?php echo $_SESSION['MM_full_names'] . "(" . $_SESSION['MM_USR_EMAIL'] . ")"; ?>&status=00&membership_id=<?php echo $row_getdetails['membership_id']; ?>&request_id=<?php echo $colname_getrequestid; ?>&moduleid=<?php echo $colname_getmoduleid; ?>"> <button class="btn btn-xs btn-danger">
																		<i class="ace-icon fa fa-trash-o bigger-120"></i> </button></a> <?php
																																	}
																																	if ($row_getdetails['status'] == '00') {

																																		?>
																<a href="profflicenseverificationcheck.php?fullnames=<?php echo $_SESSION['MM_full_names'] . "(" . $_SESSION['MM_USR_EMAIL'] . ")"; ?>&status=22&membership_id=<?php echo $row_getdetails['membership_id']; ?>&request_id=<?php echo $colname_getrequestid; ?>&moduleid=<?php echo $colname_getmoduleid; ?>"> <button class="btn btn-xs btn-success">
												...
												<div class="modal-content">
													...
													<div class="modal-body padding">
														<form enctype="multipart/form-data" method="POST" action="<?php echo $editFormAction; ?>" class="form-horizontal" name="newdetails">
															...
															<label class="col-sm-4">Watchlist membership_certificate</label>
															<div class="col-sm-8">
																<input class="form-control" id="membership_certificate" name="membership_certificate" type="file" />
															</div>
															<br />
