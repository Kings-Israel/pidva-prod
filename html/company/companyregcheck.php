...
require_once('./includes/company_reg.validator.php');
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "checkindb")) {
    ...
    if (isset($_POST['registration_number'])) {
        ...
        $query_getstudent = "SELECT * FROM pel_company_registration WHERE registration_number = '" . $registration_number . "' AND status = '11'";
        ...
        if ($totalRows_getstudent > 0) {
            ...
            $insertSQL = sprintf(
                "INSERT INTO pel_company_registration (business_type, operation_status, company_name, registration_number, status, registration_date, added_by, address, data_source, data_notes, date_added, search_id, industry, offices, country) VALUES (%s, %s, %s, %s,%s, %s, %s, %s, %s,  %s, now(), %s, %s, %s, %s)",
                GetSQLValueString(strtoupper($row_getstudent['business_type']), "text"),
                GetSQLValueString(strtoupper($row_getstudent['operation_status']), "text"),
                GetSQLValueString(strtoupper($row_getstudent['company_name']), "text"),
                GetSQLValueString(strtoupper($row_getstudent['registration_number']), "text"),
                GetSQLValueString("22", "text"),
                GetSQLValueString($row_getstudent['registration_date'], "text"),
                GetSQLValueString($_POST['added_by'], "text"),
                GetSQLValueString(strtoupper($row_getstudent['address']), "text"),
                ...
                GetSQLValueString(strtoupper($row_getstudent['industry']), "text"),
                GetSQLValueString(strtoupper($row_getstudent['offices']), "text"),
                GetSQLValueString(strtoupper($row_getstudent['country']), "text")
            );
            ...
            $updateGoTo = "companyregcheck.php?request_id=$colname_getrequestid&moduleid=$colname_getmoduleid";
            ...
            $errorcode = '<div class="alert alert-danger">
										 ...
										 NO Previous Details of Company Registration found
											<br />
										</div>';
        }
    }
} elseif ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "editdetails")) {

    $updateSQL = sprintf(
        "UPDATE pel_company_registration SET business_type=%s, operation_status=%s, company_name=%s, registration_number=%s, status=%s, registration_date=%s, added_by=%s, address=%s, data_source=%s, data_notes=%s, date_added=now(), search_id=%s, industry=%s, offices=%s, country=%s, mobile_number=%s,email_address=%s WHERE company_reg_id=%s",
        GetSQLValueString(strtoupper($_POST['business_type']), "text"),
        GetSQLValueString(strtoupper($_POST['operation_status']), "text"),
        ...
        GetSQLValueString($_POST['search_id'], "text"),
        GetSQLValueString(strtoupper($_POST['industry']), "text"),
        GetSQLValueString(strtoupper($_POST['offices']), "text"),
        GetSQLValueString(strtoupper($_POST['country']), "text"),
        // 
        GetSQLValueString(strtoupper($_POST['mobile_number']), "text"),
        GetSQLValueString(strtoupper($_POST['email_address']), "text"),
        GetSQLValueString($_POST['company_reg_id'], "text")
    );
...
} elseif ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "newdetails")) {

    $insertSQL = sprintf(
        "INSERT INTO pel_company_registration (business_type,operation_status, company_name, registration_number, status, registration_date, added_by, address, data_source, data_notes, date_added, search_id, industry, offices, country,nature_of_business, mobile_number, email_address) VALUES (%s, %s, %s,%s,%s, %s, %s, %s, %s,  %s, now(), %s, %s, %s, %s,%s, %s,%s)",
        GetSQLValueString(strtoupper($_POST['business_type']), "text"),
        GetSQLValueString(strtoupper($_POST['operation_status']), "text"),
        GetSQLValueString(strtoupper($_POST['company_name']), "text"),
        GetSQLValueString(strtoupper($_POST['registration_number']), "text"),
        ...
        GetSQLValueString(strtoupper($_POST['offices']), "text"),
        GetSQLValueString(strtoupper($_POST['country']), "text"),
        GetSQLValueString(strtoupper($_POST['nature_of_business']), "text"),
        // 
        GetSQLValueString(strtoupper($_POST['mobile_number']), "text"),
        GetSQLValueString(strtoupper($_POST['email_address']), "text")
    ...
    $sql = sprintf(
        "UPDATE pel_psmt_request_modules SET valid=%s WHERE module_id=%s AND request_ref_number=%s",
    ...
    $updateGoTo = "companyregcheck.php?request_id=$colname_getrequestid&moduleid=$colname_getmoduleid";
    // header(sprintf("Location: %s", $updateGoTo));
} elseif ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "checkinregistrar")) {

    $insertSQL = sprintf(
        "INSERT INTO pel_company_registration (business_type, registration_number, status, added_by, date_added, search_id, country, module_name) VALUES (%s, %s, %s,  %s, now(), %s, %s, %s)",
        GetSQLValueString(strtoupper($_POST['business_type']), "text"),
        GetSQLValueString(strtoupper($_POST['registration_number']), "text"),
        ...
        GetSQLValueString($_POST['search_id'], "text"),
        GetSQLValueString(strtoupper($_POST['country']), "text"),
        GetSQLValueString("companyregcheck", "text")
    );
    ...
    $updateGoTo = "companyregcheck.php?request_id=$colname_getrequestid&moduleid=$colname_getmoduleid";
    header(sprintf("Location: %s", $updateGoTo));
} elseif ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "addreject")) {

    $deleteSQLreject = sprintf(
        "UPDATE pel_company_registration SET status=%s, review_status=%s, verified_by=%s, verified_date=now(), review_notes=%s WHERE search_id=%s",
        GetSQLValueString('00', "text"),
    ...
    $updateGoTo = "companyregcheck.php?request_id=$colname_getrequestid&moduleid=$colname_getmoduleid";
    header(sprintf("Location: %s", $updateGoTo));
} elseif ((isset($_GET['company_reg_id'])) && ($_GET['company_reg_id'] != "")) {
    if ($_GET['status'] == '00') {
        $deleteSQL = sprintf(
            "UPDATE pel_company_registration SET status=%s, added_by=%s, date_added=now() WHERE company_reg_id=%s",
            GetSQLValueString($_GET['status'], "text"),
            GetSQLValueString($_GET['fullnames'], "text"),
            GetSQLValueString($_GET['company_reg_id'], "int")
        );
        mysqli_select_db($connect, $database_connect);
...
} elseif ((isset($_GET['search_id_approve'])) && ($_GET['search_id_approve'] != "")) {
    if ($invalid_count > 0) {
        approve_modules(true);
    } elseif ($_GET['status'] == '11') {
        $deleteSQL2 = sprintf(
            "UPDATE pel_company_registration SET status=%s, review_status=%s, verified_by=%s, verified_date=now() WHERE search_id=%s",
            GetSQLValueString($_GET['status'], "text"),
            GetSQLValueString("APPROVED", "text"),
            GetSQLValueString($_GET['fullnames'], "text"),
            GetSQLValueString($_GET['search_id_approve'], "text")
        );
        $Result2 = $connect->query($deleteSQL2);
        ...
        $Result3 = $connect->query($deleteSQL3);
...
<head>
    ...
    <meta charset="utf-8" />
    <title>Company Registration Details Data Management - Peleza Admin</title>
...
<body class="no-skin">
            ...
            <div class="main-content-inner">
                ...
                <div class="breadcrumbs" id="breadcrumbs">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="active">Company Registration Details</li>
                    </ul><!-- /.breadcrumb -->
                        ...
                        <div class="col-xs-12">
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <h3 align="left" class="header smaller lighter blue">Add Company Registration
                                        Details</h3>
                                </div>
                                ...
                                <div>
                                    ...
                                    $query_getdetails = "SELECT * FROM pel_company_registration WHERE search_id = '" . $search_ref . "'";
                                    ...
                                    ?>
                                        ...
                                        <div class="col-lg-12" align="center">
                                            <h3 align="left" class=" smaller lighter blue"><strong>COMPANY
                                                    REGISTRATION CHECK DETAILS: </strong>
                                            </h3>
                                            ...
                                            <table id="simple-table" class="table table-bordered table-hover">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#"><?php echo $row_getdetails['business_type']; ?> </a>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td><strong>OPERATING STATUS:</strong></td>
                                                    <td>
                                                        <a href="#"><?php echo $row_getdetails['operation_status']; ?> </a>
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $row_getdetails['registration_number']; ?></td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td><strong>ADDRESS REGISTERED:</strong></td>
                                                    <td><?php echo $row_getdetails['address']; ?></td>
                                                </tr>
                                                <tr>
                                                    <td><strong>VERIFIED PHONE NUMBER:</strong></td>
                                                    <td><?php echo $row_getdetails['mobile_number']; ?></td>
                                                </tr>
                                                <tr>
                                                    <td><strong>VERIFIED EMAIL:</strong></td>
                                                    <td><?php echo $row_getdetails['email_address']; ?></td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $row_getdetails['industry']; ?></td>
                                                </tr>
                                                <tr>
                                                    <td><strong>OFFICES:</strong></td>
                                                    <td><?php echo $row_getdetails['offices']; ?></td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <i class="ace-icon fa fa-hand-o-right icon-animated-hand-pointer blue"></i><a href="#modal-editdetails-<?php echo $row_getdetails['company_reg_id']; ?>" role="button" class="green" data-toggle="modal">
                                                            <button class="btn btn-xs btn-info">
                                                                <i class="ace-icon fa fa-pencil bigger-120"></i>
                                                            </button>
                                                        </a>

                                                        <div id="modal-editdetails-<?php echo $row_getdetails['company_reg_id']; ?>" class="modal fade" tabindex="-1">
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body padding">
                                                                        <form enctype="multipart/form-data" method="POST" action="<?php echo $editFormAction; ?>" class="form-horizontal" name="editdetails">
                                                                            ...
                                                                            <input type="hidden" id="company_reg_id" name="company_reg_id" value="<?php echo $row_getdetails['company_reg_id']; ?>" />
                                                                            ...
                                                                            <div class="col-sm-8">
                                                                                <select class="chosen-select form-control" name="business_type" id="business_type" data-placeholder="Choose Type..." required>
                                                                                    <!--  <select name="client_industry" id="client_industry">-->
                                                                                    <option value="<?php echo $row_getdetails['business_type']; ?>"><?php echo $row_getdetails['operation_status']; ?></option>
                                                                            ...
                                                                            <label class="col-sm-4">Operating
                                                                                Status</label>

                                                                            <div class="col-sm-8">
                                                                                <select class="chosen-select form-control" name="operation_status" id="operation_status" data-placeholder="Choose Type..." required>
                                                                                    <!--  <select name="client_industry" id="client_industry">-->
                                                                                    <option value="<?php echo $row_getdetails['operation_status']; ?>"><?php echo $row_getdetails['operation_status']; ?></option>
                                                                                    <option value="">Operating Status
                                                                                    </option>
                                                                            ...
                                                                            <div class="col-sm-8"><span id="sprytextfield1">
                                                                                    <input type="text" id="company_name" name="company_name" value="<?php echo $row_getdetails['company_name']; ?>" required />
                                                                            ...
                                                                            <label class="col-sm-4">Registration
                                                                                Number</label>

                                                                            <div class="col-sm-8"><span id="sprytextfield4">
                                                                                    <input type="text" value="<?php echo $row_getdetails['registration_number']; ?>" id="registration_number" name="registration_number" required />
                                                                                    <span class="textfieldRequiredMsg">*</span></span></div>
                                                                            ...
                                                                            <div class="col-sm-8">
                                                                                <input type="text" value="<?php echo $row_getdetails['address']; ?>" id="address" name="address" required />
                                                                            </div>
                                                                            ...
                                                                            <div class="col-sm-7"><span id="spryselect1">
                                                                                    <select class="chosen-select form-control" name="industry" id="industry" data-placeholder="Choose industry...">
                                                                                        <!--     <select name="client_country" id="client_country">-->
                                                                                        <option value="<?php echo $row_getdetails['industry']; ?>" selected><?php echo $row_getdetails['industry'];  ?></option>
                                                                                        <option value="000"></option>
                                                                                        <?php


                                                                                        $query_getcountries = "SELECT * FROM pel_industries ORDER BY industry_name ASC";
                                                                                        ...
                                                                                        do { ?>
                                                                                            <option value="<?php echo $row_getcountries['industry_name']; ?>"><?php echo $row_getcountries['industry_name']; ?></option>
                                                                            ...
                                                                            <div class="space-10"></div>
                                                                            <label class="col-sm-4">Verified Phone</label>

                                                                            <div class="col-sm-7"><span id="sprytextfield">
                                                                                    <input type="text" class='form-control' id="mobile_number" name="mobile_number" value="<?php echo $row_getdetails['mobile_number']; ?>" />
                                                                                    <span class="textfieldRequiredMsg">*</span></span></div>
                                                                            <br />

                                                                            <div class="space-10"></div>

                                                                            <label class="col-sm-4">Verified Email</label>

                                                                            <div class="col-sm-7"><span id="sprytextfield9">
                                                                                    <input type="email" class='form-control' id="email_address" name="email_address" value="<?php echo $row_getdetails['email_address']; ?>" />
                                                                                    <span class="textfieldRequiredMsg">*</span></span></div>
                                                                            <br />
                                                                            ...
                                                                            <div class="col-sm-7"><span id="sprytextfield8">
                                                                                    <input type="text" class='form-control' id="nature_of_business" name="nature_of_business" value="<?php echo $row_getdetails['nature_of_business']; ?>" />
                                                                                    <span class="textfieldRequiredMsg">*</span></span></div>
                                                                            <br />



                                                                            <label class="col-sm-4">offices</label>

                                                                            <div class="col-sm-7">
                                                                                <input value="<?php echo $row_getdetails['offices']; ?>" type="text" id="offices" name="offices" />
                                                                            </div>
                                                                            <br />
                                                        ...
                                                        ?>
                                                            <a href="companyregcheck.php?fullnames=<?php echo $_SESSION['MM_full_names'] . "(" . $_SESSION['MM_USR_EMAIL'] . ")"; ?>&status=00&company_reg_id=<?php echo $row_getdetails['company_reg_id']; ?>&request_id=<?php echo $colname_getrequestid; ?>&moduleid=<?php echo $colname_getmoduleid; ?>">
                                                                ...
                                                                if ($row_getdetails['status'] == '00') {
                                                                    ...
                                                                    ?>
                                                            <a href="companyregcheck.php?fullnames=<?php echo $_SESSION['MM_full_names'] . "(" . $_SESSION['MM_USR_EMAIL'] . ")"; ?>&status=22&company_reg_id=<?php echo $row_getdetails['company_reg_id']; ?>&request_id=<?php echo $colname_getrequestid; ?>&moduleid=<?php echo $colname_getmoduleid; ?>">
                                        ...
                                        <i class="ace-icon fa fa-hand-o-right icon-animated-hand-pointer blue"></i><a href="#modal-checkinregistrar" role="button" class="orange" data-toggle="modal">
                                            <button class="btn btn-xs btn-warning">
                                                <i class="ace-icon smaller-80 green"></i>Fetch from Registrar
                                            </button>
                                        </a>
 ...
 -->
                                    ...
                                    <div id="modal-checkinregistrar" class="modal fade" tabindex="-1">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header no-padding">
                                                    <div class="table-header">
                                                ...
                                                <div class="modal-body padding">
                                                    <form method="POST" action="<?php echo $editFormAction; ?>" class="form-horizontal" name="checkinregistrar">
                                                        <input type="hidden" id="request_id" name="request_id" value="<?php echo $colname_getrequestid; ?>" />
                                                        <input type="hidden" id="moduleid" name="moduleid" value="<?php echo $colname_getmoduleid; ?>" />
                                                        <input type="hidden" id="search_id" name="search_id" value="<?php echo $search_ref; ?>" />
                                                        ...
                                                        <div class="col-sm-8">
                                                            <select class="chosen-select form-control" name="business_type" id="business_type" data-placeholder="Choose Type..." required>
                                                                ...
                                                                <option value="LIMITED BY GUARANTEE COMPAN">LIMITED BY GUARANTEE COMPANY</option>
                                                        ...
                                                        <div class="col-sm-7"><span id="spryselect1">
                                                                <select class="chosen-select form-control" name="country" id="country" data-placeholder="Choose Country..." required>
                                                        ...
                                                        <input type="hidden" name="MM_insert" value="checkinregistrar">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body padding">
                                                    <form enctype="multipart/form-data" method="POST" action="<?php echo $editFormAction; ?>" class="form-horizontal" name="newdetails">
                                                        ...
                                                        <input type="hidden" id="moduleid" name="moduleid" value="<?php echo $colname_getmoduleid; ?>" />
                                                        <input type="hidden" id="company_reg_id" name="company_reg_id" />
                                                        <!-- <input type="hidden" id="company_reg_id" name="company_reg_id" value="<?php //echo $row_getdetails['company_reg_id']; 
                                                                                                                                    ?>" /> -->
                                                        ...
                                                        <label class="col-sm-4">Operating Status</label>

                                                        <div class="col-sm-8">
                                                            <select class="chosen-select form-control" name="operation_status" id="operation_status" data-placeholder="Choose Type..." required>
                                                                <!--  <select name="client_industry" id="client_industry">-->

                                                                <option value="">Operating Status</option>
                ...
                <!--  -->
                <?php
                if ($totalRows_getdetails <= 0 and $invalid_count <=  0) {
                ?>
                    <div style="width: 100%; display:flex; align-items:center;">
                        ...
                        <form action="" method="post">
                            <input type="submit" value="Mark as Negative" name="invalid" role="button" class="blue btn btn-xs btn-info" data-toggle="modal" />
                        </form>
                ...
                <?php } else { ?>
                    <br>
                    <div style="width: 100%; display:flex; align-items:center;">
                        <i class="ace-icon fa fa-hand-o-right icon-animated-hand-pointer blue"></i><a href="companyregcheck.php?fullnames=<?php echo $_SESSION['MM_full_names'] . "(" . $_SESSION['MM_USR_EMAIL'] . ")"; ?>&status=11&search_id_approve=<?php echo $search_ref; ?>&request_id=<?php echo $colname_getrequestid; ?>&moduleid=<?php echo $colname_getmoduleid; ?>">
                            <button class="btn btn-xs btn-success">
                        ...
                        <?php if ($invalid_count > 0) { ?>
                            <i class="ace-icon fa fa-hand-o-right icon-animated-hand-pointer blue"></i>
                            <form action="" method="post">
                                <input type="submit" value="Marked as Negative" name="valid" role="button" class="blue btn btn-xs btn-info" data-toggle="modal" />
                            </form>
                        <?php } ?>
                    </div>
                <?php } ?>
