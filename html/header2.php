...
if ((isset($_GET['doLogout'])) &&($_GET['doLogout']=="true")){
  ...
  $updateSQL = sprintf("UPDATE pel_users SET USR_LAST_LOGIN=%s, USR_PIN_STATUS='0' WHERE USR_USERNAME=%s",                       GetSQLValueString(date('d-m-Y H:m:s'), "text"),
...
<i class="ace-icon fa fa-envelope icon-animated-vertical"></i>
							...
							<ul class="dropdown-menu-right dropdown-navbar navbar-pink dropdown-menu dropdown-caret dropdown-close">
							  ...
							  <?php echo ($countclient + $countpay + $countusers) ; ?> Notifications								</li>
...
?>		<li>
											...
											<i class="btn btn-xs btn-primary fa fa-user"></i>
												<span class="pull-right badge badge-success"><?php echo $row_newclients['COUNT(client_id)']; ?></span>	New Registered Clients										</a>										</li>
                                                <?php
												}
												?>
   <?php
...
<li>
											<a href="../payments/education.php">
												<div class="clearfix">
													...
													<span class="pull-right badge badge-success"><?php echo $row_countnewpayments['COUNT(payment_id)']; ?></span>												</div>
											</a>										</li>
                                               <?php
												}
												?>
...
<li>
											<a href="../user/users.php">
												<div class="clearfix">
													...
													<span class="pull-right badge badge-success"><?php echo $countusers; ?></span>												</div>
											</a>										</li>
                                               <?php
												}
												?>
