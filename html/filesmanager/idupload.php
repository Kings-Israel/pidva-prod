			...
			<div class="main-content-inner">
				...
				<div class="breadcrumbs" id="breadcrumbs">
					...
					<ul class="breadcrumb">
						...
						<li class="active">Upload ID/PASSPORT Data</li>
					</ul><!-- /.breadcrumb -->
										...
										<div class="row">
											<div class="col-xs-12">
												...
												<ul>
													...
													<li>- Columns in the File should be: IDENTITY_NUMBER, IDENTITY_TYPE</li>
													<li class="style1">- Column: BOTH Columns should always have a value</li>
												</ul>
												...
												if (isset($_POST['file_token'])) {
													...
													if (is_uploaded_file($_FILES['id-input-file-2']['tmp_name'])) {
														...
														$BLOCKCHAIN = "PELDATA" . $date_insert2 . "" . $file_source . "" . $_POST['file_token'];
														...
														$file = $_FILES["id-input-file-2"]["tmp_name"];
												...
												?>
																<table width="100%" border="0" cellpadding="1" cellspacing="1">
																	<tr>
																		<td>
																			<div align="center">
																				<h2 class="title"><a href="#">DATA IN THE FILE</a></h2>
																			</div>
																		</td>
																	</tr>
																	<tr>
																		<td>
																			<div align="center"><a href="#">Scroll down to process data</a></div><br />
																		</td>
																	</tr>
																</table>
																<table id="dynamic-table" class="table table-striped table-bordered table-hover">
																	...
																	while (($data = fgetcsv($handle, 1000, ',')) !== FALSE) {
																		...
																		$IDENTITY_TYPE2 = mysqli_real_escape_string($connect, $IDENTITY_TYPE);


																		$IDENTITY_NUMBER3 = strtoupper($IDENTITY_NUMBER2);
																		$IDENTITY_TYPE3 = strtoupper($IDENTITY_TYPE2);

																		$type_upload = 'IDENTITY_DATA';


																		if ($IDENTITY_NUMBER3 == 'IDENTITY_NUMBER' || $IDENTITY_TYPE3 == 'IDENTITY_TYPE') {
																			//do nothing
																		} else {
																	?>
																			<tr>
																				<td><?php echo $y; ?></td>
																				<td><?php echo $IDENTITY_NUMBER3; ?></td>
																				<td><?php echo $IDENTITY_TYPE3; ?></td>
																			</tr>
																<?php

																			mysqli_select_db($connect, $database_connect);
																			$query_getidexisitning = "SELECT identity_number FROM pel_individual_id WHERE identity_number = '$IDENTITY_NUMBER3'";
																			$getidexisitning = mysqli_query_ported($query_getidexisitning, $connect) or die(mysqli_error($connect));
																			$row_getidexisitning = mysqli_fetch_assoc($getidexisitning);
																			$totalRows_getidexisitning = mysqli_num_rows($getidexisitning);

																			if ($totalRows_getidexisitning > 0) {
																			} else {
																				$sql_insert = "INSERT INTO pel_individual_id (identity_type,identity_number,client_name,token_number, shafile, date_added, module_name, photo_generated_status) VALUES ('$IDENTITY_TYPE3','$IDENTITY_NUMBER3','$client_name','$student_token', '$sha1content', now(), '$type_upload','00')";
																...
																<table id="simple-table" class="table table-striped table-bordered table-hover">
																	<thead>
																		...
																		<td><b class="green"><a href="dataapiprocessid.php?method=inputfile&file_token=<?php echo $file_token . ""; ?>&filenameuploaded=<?php echo $filenameuploaded . ""; ?>&file_source=<?php echo $file_source . ""; ?>&file_blockchain=<?php echo $BLOCKCHAIN . ""; ?>&uploadedby=<?php echo $uploadedby . ""; ?>&module_name=<?php echo $module_name . ""; ?>&added_date=<?php echo $date_insert . ""; ?>&sha1name=<?php echo $sha1name . ""; ?>&sha1content=<?php echo $sha1content . ""; ?>"><button class="btn btn-sm btn-success pull-left">
																						<i class="ace-icon fa fa-tick"></i>
																						Process Data </button></a></b></td>
																		<td><b class="green"><a href="deleteapiprocessid.php?method=inputfile&file_token=<?php echo $file_token . ""; ?>&filenameuploaded=<?php echo $filenameuploaded . ""; ?>&file_source=<?php echo $file_source . ""; ?>&file_blockchain=<?php echo $BLOCKCHAIN . ""; ?>&uploadedby=<?php echo $uploadedby . ""; ?>&module_name=<?php echo $module_name . ""; ?>&added_date=<?php echo $date_insert . ""; ?>&sha1name=<?php echo $sha1name . ""; ?>&sha1content=<?php echo $sha1content . ""; ?>"><button class="btn btn-sm btn-danger pull-left">
															...
															<div class="alert alert-danger">
																...
																eerror upload file <a href="idupload.php">Go Back</a>
																<br />
															</div>
														<?php
															...
															<div>
																...
																<div class="form-group">
																	...
																	<div class="col-sm-9">
																		...
																		<input type="text" id="client_name" name="client_name" class="col-xs-10 col-sm-5" />
																	</div>
																</div>
																...
																<div class="form-group">
																	...
																	<div class="col-sm-9"><span id="sprytextfield1">
																			...
																			<input type="text" id="file_source" name="file_source" class="col-xs-10 col-sm-5" accept=".csv" /> <span class="textfieldRequiredMsg">*</span></span>
																	</div>
																</div>
																...
																<div class="form-group">
																	...
																	<div class="col-sm-9"><span id="sprytextfield2">
																			<input value="IDENTITY CHECK" type="text" id="module_name" name="module_name" placeholder="Text Field" class="col-xs-10 col-sm-5" readonly /> <span class="textfieldRequiredMsg">*</span></span>
																	</div>
																</div>
