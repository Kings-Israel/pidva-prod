...
<head>
    ...
    <meta charset="utf-8"/>
    <title>Institutions- Peleza Admin</title>
        ...
        <div class="main-content-inner">
            ...
            <div class="breadcrumbs" id="breadcrumbs">
                ...
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="#">Institution Manager</a></li>


                    <li class="active">Institution Data</li>
                </ul><!-- /.breadcrumb -->
            ...
            <!-- /section:basics/content.breadcrumbs -->
            <div class="page-content" id="institution">
                ...
                <div class="row background-container">
                    <div class="col-xs-12">
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="col-xs-12">
                                    <h3 align="left" class="header smaller lighter blue">INSTITUTION DATA</h3>
                                </div>
                                ...
                                <div class="clearfix">
                                    ...
                                    <div class="row">
                                        ...
                                        <button data-target="#add-institution" data-toggle="modal" type="button"
                                                class="btn btn-info">Add Institution</button>
                                            ...
                                            <vuetable
                                                    ref="vuetable"
                                                    api-url="/v1/institution_api.php"
                                                    :fields="fields"
                                                ...
                                                <template slot="actions" scope="props">
                                                    ...
                                                    <div class="btn-group">
                                                        <button type="button" class="btn btn-warning" @click="editRow(props.rowData)"><i class="ace-icon fa fa-pencil bigger-120"></i></button>
                                                        <button type="button" class="btn btn-danger"  @click="deleteRow(props.rowData)"><i class="ace-icon fa fa-trash-o bigger-120"></i></button>
                                                    </div>
                                                </template>
                ...
                <div class="modal fade" id="add-institution" tabindex="-1" role="dialog" aria-labelledby="add-institution"
                     aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Add New Institution By <span style="display: none" id="added_by"><?php echo 	$_SESSION['MM_full_names']; ?></span></h5>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" class="form-control" id="inst_name"
                                               placeholder="Name of Institution" v-model="inst_name">
                                    </div>

                                    <div class="form-group col-md-12">
                                        <label for="student_reg_number">Institution Code</label>
                                        <input type="text" class="form-control" id="inst_code"
                                               placeholder="Institution Code" v-model="inst_code">
                                    </div>

                                    <div class="form-group col-md-12">
                                        <label for="student_first_name">Country</label>
                                        <input type="text" class="form-control" id="inst_country"
                                               placeholder="Country" v-model="inst_country">
                                    </div>

                                    <div class="form-group col-md-12">
                                        <label for="student_second_name">Email</label>
                                        <input type="text" class="form-control" id="inst_email_address"
                                               placeholder="Email " v-model="inst_email_address">
                                    </div>

                                    <div class="form-group col-md-12">
                                        <label for="student_third_name">Mobile Number</label>
                                        <input type="text" class="form-control" id="inst_mobile_number"
                                               placeholder="Mobile Number" v-model="inst_mobile_number">
                                    </div>
                                </div>
                ...
                <div class="modal fade" id="edit-institution" tabindex="-1" role="dialog" aria-labelledby="edit-institution"
                     aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Update Institution <span style="display: none" id="added_by"><?php echo 	$_SESSION['MM_full_names']; ?></span></h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                <button type="button" class="btn btn-primary" @click="updateStudentData">Submit</button>
                            </div>
                        </div>
                    </div>
                </div>
...
<script src="../../v1/js/institution.js?<?= rand(1, 1000) ?>"></script>
