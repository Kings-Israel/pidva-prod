                                ...
                                <div class="clearfix">
                                    ...
                                    <div class="row">
                                        ...
                                        <button data-target="#add-institution" data-toggle="modal" type="button"
                                                class="btn btn-info">Add Faculty</button>
...
<!--                                                        <button type="button" class="btn btn-danger"  @click="delete(props.rowData)">Delete</button>-->
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" class="form-control" id="faculty_name"
                                               placeholder="Name of Faculty" v-model="faculty_name">
                                    </div>

                                    <div class="form-group col-md-12">
                                        <label for="student_reg_number">Faculty Code</label>
                                        <input type="text" class="form-control" id="faculty_code"
                                               placeholder="Faculty Code" v-model="faculty_code">
                                    </div>
                ...
                <div class="modal fade" id="edit-faculty" tabindex="-1" role="dialog" aria-labelledby="edit-faculty"
                     aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12">
                                        <label for="data_source">Name</label>
                                        <input type="text" class="form-control" id="faculty_name"
                                               placeholder="Name of Faculty" v-model="faculty.faculty_name">
                                    </div>

                                    <div class="form-group col-md-12">
                                        <label for="student_reg_number">Faculty Code</label>
                                        <input type="text" class="form-control" id="faculty_code"
                                               placeholder="Faculty Code" v-model="faculty.faculty_code">
                                    </div>
