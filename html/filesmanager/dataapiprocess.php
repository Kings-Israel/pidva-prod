...
mysqli_select_db($connect,$database_connect);
  ...
  $graduation_congregration=$_REQUEST['graduation_congregration'];
 
$query = "SELECT count(student_id) as countnumber FROM pel_edu_data WHERE shafile ='$sha1content' and blockchain ='$file_blockchain' and file_token ='$file_token'";
$result = mysqli_query_ported($query, $connect) or die(mysqli_error($connect));
//$row = mysqli_fetch_assoc($result);

$type_upload = "EDUCATION_DATA FILE";
...
$query2 = "INSERT INTO pel_data_files (file_name,file_token, file_source, added_date, added_by, file_blockchain, module_id,module_name, count_records,shafile,graduation_congregration) VALUES ('$filenameuploaded', '$file_token','$file_source', '$added_date', '$uploadedby', '$file_blockchain', '$module_id', '$module_name','$countnumber2', '$sha1content','$graduation_congregration')";
...
$shafile=$row3['shafile'];
 ...
 $MM_fldUserAuthorization = "";
  $MM_redirectLoginSuccess = "viewfiledata.php?file_id=$ID";
  $MM_redirectLoginFailed = "educationupload.php";
