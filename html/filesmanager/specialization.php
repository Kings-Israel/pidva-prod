...
<head>
    ...
    <meta charset="utf-8"/>
    <title>Specialization- Peleza Admin</title>
        ...
        <div class="main-content-inner">
            ...
            <div class="breadcrumbs" id="breadcrumbs">
                ...
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="#">Specialization Manager</a></li>


                    <li class="active">Specialization Data</li>
                </ul><!-- /.breadcrumb -->
            ...
            <!-- /section:basics/content.breadcrumbs -->
            <div class="page-content" id="specialization">
                ...
                <div class="row background-container">
                    <div class="col-xs-12">
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="col-xs-12">
                                    <h3 align="left" class="header smaller lighter blue">SPECIALIZATION DATA</h3>
                                </div>
                                ...
                                <div class="clearfix">
                                    ...
                                    <div class="row">
                                        ...
                                        <button data-target="#add-specialization" data-toggle="modal" type="button"
                                                class="btn btn-info">Add Specialization</button>
                                            ...
                                            <vuetable
                                                    ref="vuetable"
                                                    api-url="/v1/specialization_api.php"
                                                    :fields="fields"
                ...
                <div class="modal fade" id="add-specialization" tabindex="-1" role="dialog" aria-labelledby="add-specialization"
                     aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Add New Specialization <span style="display: none" id="added_by"><?php echo 	$_SESSION['MM_full_names']; ?></span></h5>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" class="form-control" id="specialization_name"
                                               placeholder="Name of Specialization" v-model="specialization_name">
                                    </div>

                                    <div class="form-group col-md-12">
                                        <label for="student_reg_number">Specialization Code</label>
                                        <input type="text" class="form-control" id="specialization_code"
                                               placeholder="Specialization Code" v-model="specialization_code">
                                    </div>
                                    ...
                                    <div class="form-group col-md-12">
                                        <label for="inputAddress2">Select Course</label>
                                        <select id="inputState" class="form-control" v-model="course">
                ...
                <div class="modal fade" id="update-specialization" tabindex="-1" role="dialog" aria-labelledby="update-specialization" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Update Specialization <span v-text="specialization.specialization_name"></span> <span style="display: none" id="added_by"><?php echo 	$_SESSION['MM_full_names']; ?></span></h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div class="modal-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12">
                                        <label for="data_source">Specialization Name</label>
                                        <input type="text" class="form-control" id="specialization_name" placeholder="Name of Specialization" v-model="specialization.specialization_name">
                                    </div>

                                    <div class="form-group col-md-12">
                                        <label for="student_reg_number">Specialization Code</label>
                                        <input type="text" class="form-control" id="specialization_code" placeholder="Specialization Code" v-model="specialization.specialization_code">
                                    </div>
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                <button type="button" class="btn btn-primary" @click="updateSpecialization">Submit</button>
                            </div>
                        </div>
                    </div>
                </div>
...
<script src="../../v1/js/specialization.js?<?= rand(1, 1000) ?>"></script>
