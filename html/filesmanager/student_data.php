...
<head>
    ...
    <meta charset="utf-8"/>
    <title>Student Data Entry- Peleza Admin</title>
                            ...
                            <div class="col-xs-12">
                                ...
                                <div class="clearfix">
                                    ...
                                    <div class="row">
                                        ...
                                        <button data-target="#add-student" data-toggle="modal" type="button" class="btn btn-info">Add Student</button>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Add New Sudent Record</h5>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="data_source" placeholder="Data Source" v-model="data_source" required>
                                    </div>

                                    <div class="form-group col-md-6">
                                        <label for="student_reg_number">Student Registration No.</label>
                                        <input type="text" class="form-control" id="student_reg_number" placeholder="Registration Number" v-model="student_reg_number">
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="student_first_name" placeholder="First Name" v-model="student_first_name">
                                    </div>

                                    <div class="form-group col-md-4">
                                        <label for="student_second_name">Second Name</label>
                                        <input type="text" class="form-control" id="student_second_name" placeholder="Second Name" v-model="student_second_name">
                                    </div>

                                    <div class="form-group col-md-4">
                                        <label for="student_third_name">Other Name</label>
                                        <input type="text" class="form-control" id="student_third_name" placeholder="Other Name" v-model="student_third_name">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="date" class="form-control" id="graduation_date" placeholder="Graduation Date" v-model="graduation_date">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="graduation_congregation">Graduation Congregation</label>
                                        <input type="text" class="form-control" id="graduation_congregation" placeholder="Congregation" v-model="graduation_congregation">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <select id="institution_name" class="form-control" v-model="institution" required>
                                            <option selected disabled>Choose Instituition</option>
                                            <option v-for="i in institutions" v-bind:value="i" v-text="i.inst_name"></option>
                                        </select>
                                    </div>

                                    <div class="form-group col-md-6">
                                        <label for="inputAddress2">Select Faculty</label>
                                        <select id="inputState" class="form-control" v-model="faculty" required>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <select id="course_name" class="form-control" v-model="course" required>
                                            <option selected disabled>Choose Course</option>
                                            <option v-for="i in courses" v-bind:value="i" v-text="i.course_name"></option>
                                        </select>
                                    </div>

                                    <div class="form-group col-md-6">
                                        <label for="inputAddress2">Select Specialization</label>
                                        <select id="inputState" class="form-control" v-model="specialization" required>
                                            <option selected disabled>Choose Specialization</option>
                                            <option v-for="i in specializations" v-bind:value="i" v-text="i.specialization_name"></option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="inputAddress2">Select Award</label>
                                        <select id="inputState" class="form-control" v-model="award" required>
                                            <option selected disabled>Choose Award</option>
                                            <option v-for="i in awards" v-bind:value="i" v-text="i.award_name"></option>
                                        </select>
                                    </div>

                                    <div class="form-group col-md-6">
                                        <label for="course_level">Select Level</label>
                                        <select id="course_level" class="form-control" v-model="level" required>
                                            <option selected disabled>Choose Level</option>
                                            <option v-for="i in levels" v-bind:value="i" v-text="i.level_name"></option>
                                        </select>
                                    </div>
                                </div>
...
<script src="../../v1/js/education.js?<?= rand(1,1000) ?>"></script>
