...
$query="delete FROM pel_edu_data WHERE shafile ='$sha1content' and blockchain ='$file_blockchain' and file_token ='$file_token'";
...
$query2 = "delete from pel_data_files WHERE file_blockchain ='$file_blockchain'";
 ...
 $MM_fldUserAuthorization = "";
  $MM_redirectLoginSuccess = "educationupload.php";
